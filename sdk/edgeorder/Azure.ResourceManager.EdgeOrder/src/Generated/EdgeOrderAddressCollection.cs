...
namespace Azure.ResourceManager.EdgeOrder
{
    ...
    public partial class EdgeOrderAddressCollection : ArmCollection, IEnumerable<EdgeOrderAddressResource>, IAsyncEnumerable<EdgeOrderAddressResource>
    {
        ...
        /// Operation Id: Addresses_ListByResourceGroup
        /// </summary>
        ...
        public virtual AsyncPageable<EdgeOrderAddressResource> GetAllAsync(string filter = null, string skipToken = null, int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _edgeOrderAddressAddressesClientDiagnostics.CreateScope("EdgeOrderAddressCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _edgeOrderAddressAddressesRestClient.ListByResourceGroupAsync(Id.SubscriptionId, Id.ResourceGroupName, filter, skipToken, top, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<EdgeOrderAddressResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _edgeOrderAddressAddressesRestClient.ListByResourceGroupNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, filter, skipToken, top, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new EdgeOrderAddressResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<EdgeOrderAddressResource> GetAll(string filter = null, string skipToken = null, int? top = null, CancellationToken cancellationToken = default)
        {
            Page<EdgeOrderAddressResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _edgeOrderAddressAddressesRestClient.ListByResourceGroup(Id.SubscriptionId, Id.ResourceGroupName, filter, skipToken, top, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new EdgeOrderAddressResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<EdgeOrderAddressResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _edgeOrderAddressAddressesRestClient.ListByResourceGroupNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, filter, skipToken, top, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new EdgeOrderAddressResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
