    ...
    internal partial class ResourceGroupResourceExtensionClient : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<CanMigrateResult>> CanMigrateProfileAsync(WaitUntil waitUntil, CanMigrateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new CdnArmOperation<CanMigrateResult>(new CanMigrateResultOperationSource(), ProfileClientDiagnostics, Pipeline, ProfileRestClient.CreateCanMigrateRequest(Id.SubscriptionId, Id.ResourceGroupName, content).Request, response, OperationFinalStateVia.AzureAsyncOperation);
