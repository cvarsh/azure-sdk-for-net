...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class AuthorizationProviderContractCollection : ArmCollection, IEnumerable<AuthorizationProviderContractResource>, IAsyncEnumerable<AuthorizationProviderContractResource>
    {
        ...
        /// Operation Id: AuthorizationProvider_CreateOrUpdate
        /// </summary>
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/authorizationProviders
        /// Operation Id: AuthorizationProvider_ListByService
        /// </summary>
        ...
        {
            async Task<Page<AuthorizationProviderContractResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _authorizationProviderContractAuthorizationProviderClientDiagnostics.CreateScope("AuthorizationProviderContractCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _authorizationProviderContractAuthorizationProviderRestClient.ListByServiceAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, filter, top, skip, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AuthorizationProviderContractResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<AuthorizationProviderContractResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _authorizationProviderContractAuthorizationProviderClientDiagnostics.CreateScope("AuthorizationProviderContractCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _authorizationProviderContractAuthorizationProviderRestClient.ListByServiceNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, filter, top, skip, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AuthorizationProviderContractResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<AuthorizationProviderContractResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _authorizationProviderContractAuthorizationProviderClientDiagnostics.CreateScope("AuthorizationProviderContractCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _authorizationProviderContractAuthorizationProviderRestClient.ListByService(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, filter, top, skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new AuthorizationProviderContractResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<AuthorizationProviderContractResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _authorizationProviderContractAuthorizationProviderClientDiagnostics.CreateScope("AuthorizationProviderContractCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _authorizationProviderContractAuthorizationProviderRestClient.ListByServiceNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, filter, top, skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new AuthorizationProviderContractResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
