...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class AuthorizationAccessPolicyContractCollection : ArmCollection, IEnumerable<AuthorizationAccessPolicyContractResource>, IAsyncEnumerable<AuthorizationAccessPolicyContractResource>
    {
        ...
        {
            async Task<Page<AuthorizationAccessPolicyContractResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _authorizationAccessPolicyContractAuthorizationAccessPolicyClientDiagnostics.CreateScope("AuthorizationAccessPolicyContractCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _authorizationAccessPolicyContractAuthorizationAccessPolicyRestClient.ListByAuthorizationAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AuthorizationAccessPolicyContractResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<AuthorizationAccessPolicyContractResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _authorizationAccessPolicyContractAuthorizationAccessPolicyClientDiagnostics.CreateScope("AuthorizationAccessPolicyContractCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _authorizationAccessPolicyContractAuthorizationAccessPolicyRestClient.ListByAuthorizationNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AuthorizationAccessPolicyContractResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<AuthorizationAccessPolicyContractResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _authorizationAccessPolicyContractAuthorizationAccessPolicyClientDiagnostics.CreateScope("AuthorizationAccessPolicyContractCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _authorizationAccessPolicyContractAuthorizationAccessPolicyRestClient.ListByAuthorization(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new AuthorizationAccessPolicyContractResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<AuthorizationAccessPolicyContractResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _authorizationAccessPolicyContractAuthorizationAccessPolicyClientDiagnostics.CreateScope("AuthorizationAccessPolicyContractCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _authorizationAccessPolicyContractAuthorizationAccessPolicyRestClient.ListByAuthorizationNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, filter, top, skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new AuthorizationAccessPolicyContractResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
