...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class PolicyFragmentContractResource : ArmResource
    {
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/policyFragments/{id}
        /// Operation Id: PolicyFragment_Delete
        /// </summary>
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/policyFragments/{id}/listReferences
        /// Operation Id: PolicyFragment_ListReferences
        /// </summary>
        ...
        {
            async Task<Page<ResourceCollectionValueItem>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _policyFragmentContractPolicyFragmentClientDiagnostics.CreateScope("PolicyFragmentContractResource.GetReferences");
                scope.Start();
                try
                {
                    var response = await _policyFragmentContractPolicyFragmentRestClient.ListReferencesAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, top, skip, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        {
            Page<ResourceCollectionValueItem> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _policyFragmentContractPolicyFragmentClientDiagnostics.CreateScope("PolicyFragmentContractResource.GetReferences");
                scope.Start();
                try
                {
                    var response = _policyFragmentContractPolicyFragmentRestClient.ListReferences(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, top, skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, null, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/policyFragments/{id}
        /// Operation Id: PolicyFragment_GetEntityTag
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
