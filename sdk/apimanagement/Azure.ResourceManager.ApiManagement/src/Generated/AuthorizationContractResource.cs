...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class AuthorizationContractResource : ArmResource
    {
        ...
        private readonly ClientDiagnostics _authorizationConfirmConsentCodeClientDiagnostics;
        private readonly AuthorizationConfirmConsentCodeRestOperations _authorizationConfirmConsentCodeRestClient;
        ...
        internal AuthorizationContractResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _authorizationConfirmConsentCodeClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ProviderConstants.DefaultProviderNamespace, Diagnostics);
            _authorizationConfirmConsentCodeRestClient = new AuthorizationConfirmConsentCodeRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint);
#if DEBUG
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/authorizationProviders/{authorizationProviderId}/authorizations/{authorizationId}
        /// Operation Id: Authorization_Delete
        /// </summary>
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/authorizationProviders/{authorizationProviderId}/authorizations/{authorizationId}/getLoginLinks
        /// Operation Id: AuthorizationLoginLinks_Post
        /// </summary>
        ...
        /// Operation Id: AuthorizationConfirmConsentCode_Post
        /// </summary>
        ...
        public virtual async Task<Response<BinaryData>> PostAuthorizationConfirmConsentCodeAsync(AuthorizationConfirmConsentCodeRequestContract authorizationConfirmConsentCodeRequestContract, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _authorizationConfirmConsentCodeClientDiagnostics.CreateScope("AuthorizationContractResource.PostAuthorizationConfirmConsentCode");
            scope.Start();
            try
            {
                var response = await _authorizationConfirmConsentCodeRestClient.PostAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, authorizationConfirmConsentCodeRequestContract, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="authorizationConfirmConsentCodeRequestContract"/> is null. </exception>
        public virtual Response<BinaryData> PostAuthorizationConfirmConsentCode(AuthorizationConfirmConsentCodeRequestContract authorizationConfirmConsentCodeRequestContract, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(authorizationConfirmConsentCodeRequestContract, nameof(authorizationConfirmConsentCodeRequestContract));
            ...
            try
            {
                var response = _authorizationConfirmConsentCodeRestClient.Post(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, authorizationConfirmConsentCodeRequestContract, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
