...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class PolicyFragmentContractCollection : ArmCollection, IEnumerable<PolicyFragmentContractResource>, IAsyncEnumerable<PolicyFragmentContractResource>
    {
        ...
        /// Operation Id: PolicyFragment_CreateOrUpdate
        /// </summary>
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/policyFragments
        /// Operation Id: PolicyFragment_ListByService
        /// </summary>
        ...
        {
            async Task<Page<PolicyFragmentContractResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _policyFragmentContractPolicyFragmentClientDiagnostics.CreateScope("PolicyFragmentContractCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _policyFragmentContractPolicyFragmentRestClient.ListByServiceAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, filter, orderBy, top, skip, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new PolicyFragmentContractResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
        ...
        {
            Page<PolicyFragmentContractResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _policyFragmentContractPolicyFragmentClientDiagnostics.CreateScope("PolicyFragmentContractCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _policyFragmentContractPolicyFragmentRestClient.ListByService(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, filter, orderBy, top, skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new PolicyFragmentContractResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
