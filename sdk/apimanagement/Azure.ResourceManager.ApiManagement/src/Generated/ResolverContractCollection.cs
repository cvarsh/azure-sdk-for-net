...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ResolverContractCollection : ArmCollection, IEnumerable<ResolverContractResource>, IAsyncEnumerable<ResolverContractResource>
    {
        ...
        {
            async Task<Page<ResolverContractResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _resolverContractGraphQLApiResolverClientDiagnostics.CreateScope("ResolverContractCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _resolverContractGraphQLApiResolverRestClient.ListByApiAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, top, skip, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ResolverContractResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<ResolverContractResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _resolverContractGraphQLApiResolverClientDiagnostics.CreateScope("ResolverContractCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _resolverContractGraphQLApiResolverRestClient.ListByApiNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, top, skip, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ResolverContractResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<ResolverContractResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _resolverContractGraphQLApiResolverClientDiagnostics.CreateScope("ResolverContractCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _resolverContractGraphQLApiResolverRestClient.ListByApi(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, top, skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ResolverContractResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<ResolverContractResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _resolverContractGraphQLApiResolverClientDiagnostics.CreateScope("ResolverContractCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _resolverContractGraphQLApiResolverRestClient.ListByApiNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, top, skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ResolverContractResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
