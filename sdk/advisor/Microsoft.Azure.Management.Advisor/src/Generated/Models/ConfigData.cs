...
namespace Microsoft.Azure.Management.Advisor.Models
{
    ...
    public partial class ConfigData : Resource
    {
        ...
        /// <param name="duration">Minimum duration for Advisor low CPU
        /// utilization evaluation. Valid only for subscriptions. Valid values:
        /// 7 (default), 14, 21, 30, 60 or 90. Possible values include: '7',
        /// '14', '21', '30', '60', '90'</param>
        /// <param name="digests">Advisor digest configuration. Valid only for
        /// subscriptions</param>
        public ConfigData(string id = default(string), string name = default(string), string type = default(string), bool? exclude = default(bool?), string lowCpuThreshold = default(string), string duration = default(string), IList<DigestConfig> digests = default(IList<DigestConfig>))
            : base(id, name, type)
        {
            Exclude = exclude;
        ...
        /// <summary>
        /// Gets or sets minimum duration for Advisor low CPU utilization
        /// evaluation. Valid only for subscriptions. Valid values: 7
        /// (default), 14, 21, 30, 60 or 90. Possible values include: '7',
        /// '14', '21', '30', '60', '90'
        /// </summary>
