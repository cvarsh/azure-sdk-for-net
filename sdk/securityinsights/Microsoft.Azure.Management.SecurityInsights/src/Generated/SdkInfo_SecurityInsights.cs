      ...
      public static IEnumerable<Tuple<string, string, string>> ApiInfo_SecurityInsights
      {
          get
          {
              return new Tuple<string, string, string>[]
              {
                ...
                new Tuple<string, string, string>("OperationalInsights", "WorkspaceManagerAssignmentJobs", "2023-03-01-preview"),
                new Tuple<string, string, string>("OperationalInsights", "WorkspaceManagerAssignments", "2023-03-01-preview"),
