...
namespace Microsoft.Azure.Management.SecurityInsights
{
    ...
    internal partial class ThreatIntelligenceIndicatorsOperations : IServiceOperations<SecurityInsights>, IThreatIntelligenceIndicatorsOperations
    {
        ...
        public async Task<AzureOperationResponse<IPage<ThreatIntelligenceInformation>>> ListWithHttpMessagesAsync(string resourceGroupName, string workspaceName, string filter = default(string), int? top = default(int?), string skipToken = default(string), string orderby = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/threatIntelligence/main/indicators").ToString();
