...
namespace Microsoft.Azure.Management.SecurityInsights.Models
{
    ...
    public partial class OfficeDataConnector : DataConnector
    {
        ...
        /// connector.</param>
        public OfficeDataConnector(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), string etag = default(string), string tenantId = default(string), OfficeDataConnectorDataTypes dataTypes = default(OfficeDataConnectorDataTypes))
