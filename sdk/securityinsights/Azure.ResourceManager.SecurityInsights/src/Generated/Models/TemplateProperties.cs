...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        /// <summary> Initializes a new instance of TemplateProperties. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="contentId"/>, <paramref name="displayName"/>, <paramref name="version"/> or <paramref name="source"/> is null. </exception>
        public TemplateProperties(string contentId, string displayName, SecurityInsightsKind contentKind, string version, ContentMetadataSource source)
        {
