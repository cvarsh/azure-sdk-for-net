...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ContentMetadataDependencies. </summary>
        public ContentMetadataDependencies()
        {
            Criteria = new ChangeTrackingList<ContentMetadataDependencies>();
        }
        ...
        internal ContentMetadataDependencies(string contentId, SecurityInsightsKind? kind, string version, string name, Operator? @operator, IList<ContentMetadataDependencies> criteria)
        {
            ContentId = contentId;
            Kind = kind;
            Version = version;
        ...
        public IList<ContentMetadataDependencies> Criteria { get; }
    }
}
