...
{
    public partial class ContentMetadataDependencies : IUtf8JsonSerializable
    {
        ...
        internal static ContentMetadataDependencies DeserializeContentMetadataDependencies(JsonElement element)
        {
            ...
            Optional<IList<ContentMetadataDependencies>> criteria = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("criteria"))
                {
                    ...
                    List<ContentMetadataDependencies> array = new List<ContentMetadataDependencies>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(DeserializeContentMetadataDependencies(item));
                    }
                    criteria = array;
                    continue;
                }
            }
            return new ContentMetadataDependencies(contentId.Value, Optional.ToNullable(kind), version.Value, name.Value, Optional.ToNullable(@operator), Optional.ToList(criteria));
        }
    }
}
