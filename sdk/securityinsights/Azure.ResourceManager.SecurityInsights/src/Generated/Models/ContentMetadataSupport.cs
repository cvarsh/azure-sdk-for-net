...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ContentMetadataSupport. </summary>
        /// <param name="tier"> Type of support for content item. </param>
        public ContentMetadataSupport(SupportTier tier)
        {
            Tier = tier;
        }
        ...
        internal ContentMetadataSupport(SupportTier tier, string name, string email, string link)
        {
            Tier = tier;
            Name = name;
            Email = email;
