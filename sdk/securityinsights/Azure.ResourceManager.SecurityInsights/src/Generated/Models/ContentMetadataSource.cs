...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ContentMetadataSource. </summary>
        /// <param name="kind"> Source type of the content. </param>
        public ContentMetadataSource(SourceKind kind)
        {
            Kind = kind;
        }
        ...
        internal ContentMetadataSource(SourceKind kind, string name, string sourceId)
        {
            Kind = kind;
            Name = name;
            SourceId = sourceId;
