...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public partial class IncidentData : ResourceData
    {
        ...
        internal IncidentData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string title, string description, IncidentSeverity? severity, IncidentStatus? status, IncidentClassification? classification, IncidentClassificationReason? classificationReason, string classificationComment, IncidentOwnerInfo owner, IList<IncidentLabel> labels, DateTimeOffset? firstActivityTimeUtc, DateTimeOffset? lastActivityTimeUtc, DateTimeOffset? lastModifiedTimeUtc, DateTimeOffset? createdTimeUtc, int? incidentNumber, IncidentAdditionalData additionalData, IReadOnlyList<string> relatedAnalyticRuleIds, Uri incidentUri, string providerName, string providerIncidentId, TeamInformation teamInformation, ETag? etag) : base(id, name, resourceType, systemData)
        {
            Title = title;
