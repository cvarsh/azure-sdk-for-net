...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class FirewallPoliciesOperationsExtensions
    {
            ...
            /// Expands referenced resources.
            /// </param>
            public static FirewallPolicyDraft GetDraft(this IFirewallPoliciesOperations operations, string resourceGroupName, string firewallPolicyName, string expand = default(string))
            {
                return operations.GetDraftAsync(resourceGroupName, firewallPolicyName, expand).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<FirewallPolicyDraft> GetDraftAsync(this IFirewallPoliciesOperations operations, string resourceGroupName, string firewallPolicyName, string expand = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetDraftWithHttpMessagesAsync(resourceGroupName, firewallPolicyName, expand, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The name of the Firewall Policy.
            /// </param>
            public static void DeployDraft(this IFirewallPoliciesOperations operations, string resourceGroupName, string firewallPolicyName)
            {
                operations.DeployDraftAsync(resourceGroupName, firewallPolicyName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task DeployDraftAsync(this IFirewallPoliciesOperations operations, string resourceGroupName, string firewallPolicyName, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.DeployDraftWithHttpMessagesAsync(resourceGroupName, firewallPolicyName, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            /// The name of the Firewall Policy.
            /// </param>
            public static void BeginDeployDraft(this IFirewallPoliciesOperations operations, string resourceGroupName, string firewallPolicyName)
            {
                operations.BeginDeployDraftAsync(resourceGroupName, firewallPolicyName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task BeginDeployDraftAsync(this IFirewallPoliciesOperations operations, string resourceGroupName, string firewallPolicyName, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.BeginDeployDraftWithHttpMessagesAsync(resourceGroupName, firewallPolicyName, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
