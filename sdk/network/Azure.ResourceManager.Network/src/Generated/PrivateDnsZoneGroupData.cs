...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PrivateDnsZoneGroupData : NetworkResourceData
    {
        ...
        internal PrivateDnsZoneGroupData(ResourceIdentifier id, string name, ResourceType? resourceType, string etag, NetworkProvisioningState? provisioningState, IList<PrivateDnsZoneConfig> privateDnsZoneConfigs) : base(id, name, resourceType)
        {
            Etag = etag;
