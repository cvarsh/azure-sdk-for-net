...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class NetworkPrivateLinkServiceConnection : NetworkResourceData
    {
        ...
        internal NetworkPrivateLinkServiceConnection(ResourceIdentifier id, string name, ResourceType? resourceType, ETag? etag, NetworkProvisioningState? provisioningState, ResourceIdentifier privateLinkServiceId, string resolvedPrivateLinkServiceLocation, IList<string> groupIds, string requestMessage, NetworkPrivateLinkServiceConnectionState connectionState) : base(id, name, resourceType)
        {
            ETag = etag;
