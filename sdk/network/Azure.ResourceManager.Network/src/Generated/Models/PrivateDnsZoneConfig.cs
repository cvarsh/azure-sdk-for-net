...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PrivateDnsZoneConfig
    {
        ...
        internal PrivateDnsZoneConfig(string name, string id, string resourceType, string etag, string privateDnsZoneId, NetworkProvisioningState? provisioningState, IReadOnlyList<RecordSet> recordSets)
        {
            Name = name;
            Id = id;
