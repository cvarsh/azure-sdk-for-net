...
namespace Azure.ResourceManager.Network.Models
{
    public partial class NetworkPrivateLinkServiceConnection : IUtf8JsonSerializable
    {
        ...
        internal static NetworkPrivateLinkServiceConnection DeserializeNetworkPrivateLinkServiceConnection(JsonElement element)
        {
            ...
            return new NetworkPrivateLinkServiceConnection(id.Value, name.Value, Optional.ToNullable(type), Optional.ToNullable(etag), Optional.ToNullable(provisioningState), privateLinkServiceId.Value, resolvedPrivateLinkServiceLocation.Value, Optional.ToList(groupIds), requestMessage.Value, privateLinkServiceConnectionState.Value);
        }
    }
}
