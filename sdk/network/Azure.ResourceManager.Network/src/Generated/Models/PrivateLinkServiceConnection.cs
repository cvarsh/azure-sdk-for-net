...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class PrivateLinkServiceConnection : NetworkResourceData
    {
        ...
        internal PrivateLinkServiceConnection(ResourceIdentifier id, string name, ResourceType? resourceType, ETag? eTag, NetworkProvisioningState? provisioningState, ResourceIdentifier privateLinkServiceId, string resolvedPrivateLinkServiceLocation, IList<string> groupIds, string requestMessage, NetworkPrivateLinkServiceConnectionState connectionState) : base(id, name, resourceType)
        {
            ETag = eTag;
