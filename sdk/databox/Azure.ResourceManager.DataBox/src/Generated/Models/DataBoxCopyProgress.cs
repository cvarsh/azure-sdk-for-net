...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxCopyProgress : CustomerInterventionStageProgress
    {
        ...
        /// </param>
        internal DataBoxCopyProgress(ResponseError error, IReadOnlyList<CustomerResolutionCode> actions, string storageAccountName, DataBoxJobTransferType? transferType, DataAccountType? dataAccountType, ResourceIdentifier accountId, long? bytesProcessed, long? totalBytesToProcess, long? filesProcessed, long? totalFilesToProcess, long? invalidFilesProcessed, long? invalidFileBytesUploaded, long? renamedContainerCount, long? filesErroredOut, long? directoriesErroredOut, long? invalidDirectoriesProcessed, bool? isEnumerationInProgress) : base(error, actions)
        {
