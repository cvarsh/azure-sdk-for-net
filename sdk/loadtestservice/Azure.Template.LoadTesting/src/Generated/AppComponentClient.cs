...
namespace Azure.Template.LoadTesting
{
    ...
    public partial class AppComponentClient
    {
        ...
        public AppComponentClient(string endpoint, TokenCredential credential) : this(endpoint, credential, null, new LoadTestingClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public AppComponentClient(string endpoint, TokenCredential credential, string testId, LoadTestingClientOptions options)
        {
        ...
        /// <param name="name"> Unique name of the app component, must contain only lower-case alphabetic, numeric, underscore or hyphen characters. </param>
        ...
        ///   testId: string, # Optional. [Required, if testRunId is not given] Load test unique name
        ///   testRunId: string, # Optional. [Required if testId is not given] Load test run unique name
        ///   name: string, # Optional. AppComponent name
        ///   value: Dictionary&lt;string, AppComponent&gt;, # Required. AppComponents collection { resource id (fully qualified resource Id e.g subscriptions/{subId}/resourceGroups/{rg}/providers/Microsoft.LoadTestService/loadtests/{resName}) : resource object } 
        /// }
        /// </code>
        /// 
        /// Response Body:
        ...
        /// <summary> Get app Component details by unique name. </summary>
        /// <param name="name"> Unique name of the app component, must contain only lower-case alphabetic, numeric, underscore or hyphen characters. </param>
        /// <param name="context"> The request context, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="name"/> is an empty string, and was expected to be non-empty. </exception>
        ...
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <example>
        /// This sample shows how to call GetAppComponentAsync with required parameters and parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var client = new AppComponentClient("<https://my-service.azure.com>", credential);
        /// 
        /// Response response = await client.GetAppComponentAsync("<name>");
        /// 
        /// JsonElement result = JsonDocument.Parse(response.ContentStream).RootElement;
        /// Console.WriteLine(result.GetProperty("resourceId").ToString());
        /// Console.WriteLine(result.GetProperty("testId").ToString());
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> GetAppComponentAsync(string name, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));
            ...
            try
            {
                using HttpMessage message = CreateGetAppComponentRequest(name, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <example>
        /// This sample shows how to call GetAppComponent with required parameters and parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var client = new AppComponentClient("<https://my-service.azure.com>", credential);
        /// 
        /// Response response = client.GetAppComponent("<name>");
        /// 
        /// JsonElement result = JsonDocument.Parse(response.ContentStream).RootElement;
        /// Console.WriteLine(result.GetProperty("resourceId").ToString());
        /// Console.WriteLine(result.GetProperty("testId").ToString());
        ...
        /// 
        /// </remarks>
        public virtual Response GetAppComponent(string name, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));
        ...
        /// <summary> Get an app component for a test or a test run by its name. </summary>
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("AppComponentClient.GetByTestOrTestRun");
            scope.Start();
            try
            {
        ...
        internal HttpMessage CreateGetAppComponentRequest(string name, RequestContext context)
        {
