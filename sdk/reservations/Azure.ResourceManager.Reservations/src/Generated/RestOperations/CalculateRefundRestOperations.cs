...
namespace Azure.ResourceManager.Reservations
{
    internal partial class CalculateRefundRestOperations
    {
        ...
        internal HttpMessage CreatePostRequest(CalculateRefundContent content)
        {
            ...
            uri.Reset(_endpoint);
            uri.AppendPath("/providers/Microsoft.Capacity/calculateRefund", false);
        ...
        public async Task<Response<CalculateRefundResponse>> PostAsync(CalculateRefundContent content, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public Response<CalculateRefundResponse> Post(CalculateRefundContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
