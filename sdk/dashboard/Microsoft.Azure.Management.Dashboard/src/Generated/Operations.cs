...
namespace Microsoft.Azure.Management.Dashboard
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<DashboardManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(DashboardManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Dashboard/operations").ToString();
