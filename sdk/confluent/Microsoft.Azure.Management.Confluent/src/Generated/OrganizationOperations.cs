...
namespace Microsoft.Azure.Management.Confluent
{
    ...
    /// </summary>
    internal partial class OrganizationOperations : IServiceOperations<ConfluentManagementClient>, IOrganizationOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal OrganizationOperations(ConfluentManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<OperationResult>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Confluent/operations").ToString();
