...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteResource : ArmResource
    {
        ...
        /// <summary> Gets an object representing a SiteWorkflowsConfigurationResource along with the instance operations that can be performed on it in the WebSite. </summary>
        /// <returns> Returns a <see cref="SiteWorkflowsConfigurationResource" /> object. </returns>
        public virtual SiteWorkflowsConfigurationResource GetSiteWorkflowsConfiguration()
        {
            return new SiteWorkflowsConfigurationResource(Client, new ResourceIdentifier(Id.ToString() + "/workflowsConfiguration/connections"));
        }
