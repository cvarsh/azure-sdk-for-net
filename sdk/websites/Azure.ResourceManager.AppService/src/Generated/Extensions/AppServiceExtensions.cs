...
namespace Azure.ResourceManager.AppService
{
    ...
    public static partial class AppServiceExtensions
    {
        ...
        [ForwardsClientCalls]
        public static async Task<Response<LocationDetectorResource>> GetLocationDetectorAsync(this SubscriptionResource subscriptionResource, AzureLocation location, string detectorName, string resourceType, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            return await subscriptionResource.GetLocationDetectors(location).GetAsync(detectorName, resourceType, startTime, endTime, timeGrain, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="detectorName"/> or <paramref name="resourceType"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<LocationDetectorResource> GetLocationDetector(this SubscriptionResource subscriptionResource, AzureLocation location, string detectorName, string resourceType, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, string timeGrain = null, CancellationToken cancellationToken = default)
        {
            return subscriptionResource.GetLocationDetectors(location).Get(detectorName, resourceType, startTime, endTime, timeGrain, cancellationToken);
        }
