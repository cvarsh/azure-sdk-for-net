...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class LocationDetectorCollection : ArmCollection
    {
        ...
        public virtual async Task<Response<LocationDetectorResource>> GetAsync(string detectorName, string resourceType, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _locationDetectorDiagnosticsRestClient.GetProviderDetectorResponseAsync(Id.SubscriptionId, new AzureLocation(_location), detectorName, resourceType, cancellationToken).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentException"> <paramref name="detectorName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="detectorName"/> or <paramref name="resourceType"/> is null. </exception>
        public virtual Response<LocationDetectorResource> Get(string detectorName, string resourceType, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(detectorName, nameof(detectorName));
            Argument.AssertNotNull(resourceType, nameof(resourceType));
            ...
            try
            {
                var response = _locationDetectorDiagnosticsRestClient.GetProviderDetectorResponse(Id.SubscriptionId, new AzureLocation(_location), detectorName, resourceType, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new LocationDetectorResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <exception cref="ArgumentException"> <paramref name="detectorName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="detectorName"/> or <paramref name="resourceType"/> is null. </exception>
        public virtual async Task<Response<bool>> ExistsAsync(string detectorName, string resourceType, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(detectorName, nameof(detectorName));
            Argument.AssertNotNull(resourceType, nameof(resourceType));
            ...
            try
            {
                var response = await _locationDetectorDiagnosticsRestClient.GetProviderDetectorResponseAsync(Id.SubscriptionId, new AzureLocation(_location), detectorName, resourceType, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentException"> <paramref name="detectorName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="detectorName"/> or <paramref name="resourceType"/> is null. </exception>
        public virtual Response<bool> Exists(string detectorName, string resourceType, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(detectorName, nameof(detectorName));
            Argument.AssertNotNull(resourceType, nameof(resourceType));
            ...
            try
            {
                var response = _locationDetectorDiagnosticsRestClient.GetProviderDetectorResponse(Id.SubscriptionId, new AzureLocation(_location), detectorName, resourceType, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
