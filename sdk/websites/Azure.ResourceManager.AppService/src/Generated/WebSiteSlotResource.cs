...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class WebSiteSlotResource : ArmResource
    {
        ...
        /// <summary> Gets an object representing a SiteSlotWorkflowsConfigurationResource along with the instance operations that can be performed on it in the WebSiteSlot. </summary>
        /// <returns> Returns a <see cref="SiteSlotWorkflowsConfigurationResource" /> object. </returns>
        public virtual SiteSlotWorkflowsConfigurationResource GetSiteSlotWorkflowsConfiguration()
        {
            return new SiteSlotWorkflowsConfigurationResource(Client, new ResourceIdentifier(Id.ToString() + "/workflowsConfiguration/connections"));
        }
