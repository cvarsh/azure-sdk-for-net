...
namespace Microsoft.Azure.Management.DevTestLabs
{
    ...
    public static partial class ServiceFabricSchedulesOperationsExtensions
    {
            ...
            /// The name of the schedule.
            /// </param>
            public static void Execute(this IServiceFabricSchedulesOperations operations, string resourceGroupName, string labName, string userName, string serviceFabricName, string name)
            {
                operations.ExecuteAsync(resourceGroupName, labName, userName, serviceFabricName, name).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task ExecuteAsync(this IServiceFabricSchedulesOperations operations, string resourceGroupName, string labName, string userName, string serviceFabricName, string name, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.ExecuteWithHttpMessagesAsync(resourceGroupName, labName, userName, serviceFabricName, name, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
