...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class LabCost : Resource
    {
        ...
        /// resource</param>
        public LabCost(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string location = default(string), string status = default(string), int? target = default(int?), IList<CostThresholdProperties> costThresholds = default(IList<CostThresholdProperties>), System.DateTime? cycleStartDateTime = default(System.DateTime?), System.DateTime? cycleEndDateTime = default(System.DateTime?), string cycleType = default(string), double? estimatedLabCost = default(double?), IList<LabCostDetailsProperties> labCostDetails = default(IList<LabCostDetailsProperties>), IList<LabResourceCostProperties> resourceCosts = default(IList<LabResourceCostProperties>), string currencyCode = default(string), System.DateTime? startDateTime = default(System.DateTime?), System.DateTime? endDateTime = default(System.DateTime?), System.DateTime? createdDate = default(System.DateTime?), string provisioningState = default(string), string uniqueIdentifier = default(string), SystemData systemData = default(SystemData))
