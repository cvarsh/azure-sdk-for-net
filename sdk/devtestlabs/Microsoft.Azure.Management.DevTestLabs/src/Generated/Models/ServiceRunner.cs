...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class ServiceRunner : Resource
    {
        ...
        /// resource</param>
        public ServiceRunner(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string location = default(string), string identityUsageType = default(string), string provisioningState = default(string), string uniqueIdentifier = default(string), string serviceRunnerType = default(string), string principalId = default(string), string tenantId = default(string), string clientSecretUrl = default(string), IDictionary<string, object> userAssignedIdentities = default(IDictionary<string, object>), SystemData systemData = default(SystemData))
