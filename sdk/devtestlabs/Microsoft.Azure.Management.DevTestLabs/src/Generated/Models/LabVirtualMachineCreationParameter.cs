...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class LabVirtualMachineCreationParameter
    {
        ...
        public LabVirtualMachineCreationParameter(LabVirtualMachineCreationParameterProperties properties = default(LabVirtualMachineCreationParameterProperties), string name = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
