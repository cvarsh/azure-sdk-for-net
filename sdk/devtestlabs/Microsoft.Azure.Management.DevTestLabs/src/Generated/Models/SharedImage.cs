...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class SharedImage : Resource
    {
        ...
        /// resource</param>
        public SharedImage(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string location = default(string), string definitionName = default(string), string osType = default(string), string imageType = default(string), string enableState = default(string), string displayName = default(string), IList<ImageVersionProperties> versions = default(IList<ImageVersionProperties>), string provisioningState = default(string), string uniqueIdentifier = default(string), SystemData systemData = default(SystemData))
