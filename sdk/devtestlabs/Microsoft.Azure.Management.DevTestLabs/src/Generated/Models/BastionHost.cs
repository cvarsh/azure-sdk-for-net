...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class BastionHost : Resource
    {
        ...
        /// resource</param>
        public BastionHost(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string location = default(string), string externalBastionHostId = default(string), string ipAddressId = default(string), string provisioningState = default(string), string uniqueIdentifier = default(string), SystemData systemData = default(SystemData))
