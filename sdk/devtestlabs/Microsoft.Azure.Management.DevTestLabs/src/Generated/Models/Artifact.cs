...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class Artifact : Resource
    {
        ...
        /// resource</param>
        public Artifact(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string location = default(string), string title = default(string), string description = default(string), string publisher = default(string), string filePath = default(string), string icon = default(string), string targetOsType = default(string), object parameters = default(object), System.DateTime? createdDate = default(System.DateTime?), SystemData systemData = default(SystemData))
