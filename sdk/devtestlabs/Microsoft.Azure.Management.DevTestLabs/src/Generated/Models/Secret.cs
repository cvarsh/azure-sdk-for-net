...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class Secret : Resource
    {
        ...
        /// resource</param>
        public Secret(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string location = default(string), string value = default(string), string provisioningState = default(string), string uniqueIdentifier = default(string), SystemData systemData = default(SystemData))
