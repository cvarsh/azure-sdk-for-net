...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class ArmTemplate : Resource
    {
        ...
        /// resource</param>
        public ArmTemplate(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string location = default(string), string displayName = default(string), string description = default(string), string publisher = default(string), string icon = default(string), object contents = default(object), System.DateTime? createdDate = default(System.DateTime?), IList<ParametersValueFileInfo> parametersValueFilesInfo = default(IList<ParametersValueFileInfo>), bool? enabled = default(bool?), SystemData systemData = default(SystemData))
