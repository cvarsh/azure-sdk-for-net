...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class GalleryImage : Resource
    {
        ...
        /// resource</param>
        public GalleryImage(string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string location = default(string), string author = default(string), System.DateTime? createdDate = default(System.DateTime?), string description = default(string), string offer = default(string), string publisher = default(string), string sku = default(string), string osType = default(string), string version = default(string), string icon = default(string), bool? enabled = default(bool?), string planId = default(string), bool? isPlanAuthorized = default(bool?), SystemData systemData = default(SystemData))
