...
namespace Microsoft.Azure.Management.DevTestLabs.Models
{
    ...
    public partial class CustomImage : Resource
    {
        ...
        /// resource</param>
        public CustomImage(string osType, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string location = default(string), string sourceVmId = default(string), string windowsOsState = default(string), string linuxOsState = default(string), string imageName = default(string), bool? sysPrep = default(bool?), string description = default(string), string author = default(string), System.DateTime? creationDate = default(System.DateTime?), string managedImageId = default(string), string managedSnapshotId = default(string), IList<DataDiskStorageTypeInfo> dataDiskStorageInfo = default(IList<DataDiskStorageTypeInfo>), string customImageId = default(string), string publisher = default(string), string offer = default(string), bool? isPlanAuthorized = default(bool?), string provisioningState = default(string), string uniqueIdentifier = default(string), SystemData systemData = default(SystemData))
