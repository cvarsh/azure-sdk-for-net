...
namespace Microsoft.Azure.Management.ResourceGraph
{
    ...
    public partial class ResourceGraphClient : ServiceClient<ResourceGraphClient>, IResourceGraphClient, IAzureClient
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IDictionary<string, object>>> ResourcesHistoryWithHttpMessagesAsync(ResourcesHistoryRequest request, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (request == null)
            {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IDictionary<string, object>>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
