...
namespace Microsoft.Azure.Management.ResourceGraph
{
    ...
    public partial interface IResourceGraphClient : System.IDisposable
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<IDictionary<string, object>>> ResourcesHistoryWithHttpMessagesAsync(ResourcesHistoryRequest request, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
