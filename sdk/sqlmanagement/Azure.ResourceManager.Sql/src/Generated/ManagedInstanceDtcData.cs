...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class ManagedInstanceDtcData : ResourceData
    {
        ...
        internal ManagedInstanceDtcData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, bool? dtcEnabled, ManagedInstanceDtcSecuritySettings securitySettings, IList<string> externalDnsSuffixSearchList, string dtcHostNameDnsSuffix, ProvisioningState? provisioningState) : base(id, name, resourceType, systemData)
        {
