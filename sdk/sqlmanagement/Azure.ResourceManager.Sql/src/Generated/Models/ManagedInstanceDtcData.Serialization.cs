...
namespace Azure.ResourceManager.Sql
{
    public partial class ManagedInstanceDtcData : IUtf8JsonSerializable
    {
        ...
        internal static ManagedInstanceDtcData DeserializeManagedInstanceDtcData(JsonElement element)
        {
            ...
            return new ManagedInstanceDtcData(id, name, type, systemData, Optional.ToNullable(dtcEnabled), securitySettings.Value, Optional.ToList(externalDnsSuffixSearchList), dtcHostNameDnsSuffix.Value, Optional.ToNullable(provisioningState));
        }
    }
}
