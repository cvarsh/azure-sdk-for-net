...
{
    /// <summary> A list of the server trust certificates which are used for secure communication between SQL On-Prem instance and the given Sql Managed Instance. </summary>
