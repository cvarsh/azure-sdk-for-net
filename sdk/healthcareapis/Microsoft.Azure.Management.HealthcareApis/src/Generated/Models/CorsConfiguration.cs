...
namespace Microsoft.Azure.Management.HealthcareApis.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the CorsConfiguration class.
        /// </summary>
        ...
        /// CORS.</param>
        public CorsConfiguration(IList<string> origins = default(IList<string>), IList<string> headers = default(IList<string>), IList<string> methods = default(IList<string>), int? maxAge = default(int?), bool? allowCredentials = default(bool?))
        {
            Origins = origins;
            Headers = headers;
            Methods = methods;
