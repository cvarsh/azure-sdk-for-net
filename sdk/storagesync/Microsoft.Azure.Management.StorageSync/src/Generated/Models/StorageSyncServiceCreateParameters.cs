...
namespace Microsoft.Azure.Management.StorageSync.Models
{
    ...
    public partial class StorageSyncServiceCreateParameters
    {
        ...
        /// identities</param>
        public StorageSyncServiceCreateParameters(string location, IDictionary<string, string> tags = default(IDictionary<string, string>), string incomingTrafficPolicy = default(string), string identityType = default(string), string identityId = default(string))
        {
            Location = location;
            Tags = tags;
