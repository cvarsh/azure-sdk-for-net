...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class ConnectionSettingProperties
    {
        ...
        internal ConnectionSettingProperties(string clientId, string settingId, string clientSecret, string scopes, string serviceProviderId, string serviceProviderDisplayName, IList<ConnectionSettingParameter> parameters, string provisioningState)
        {
            ClientId = clientId;
            SettingId = settingId;
