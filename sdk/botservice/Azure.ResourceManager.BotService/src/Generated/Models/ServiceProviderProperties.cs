...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class ServiceProviderProperties
    {
        ...
        internal ServiceProviderProperties(string id, string displayName, string serviceProviderName, Uri devPortalUri, Uri iconUri, IReadOnlyList<ServiceProviderParameter> parameters)
        {
            Id = id;
