...
namespace Azure.ResourceManager.BotService.Models
{
    public partial class TelephonyChannelProperties : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WritePropertyName("apiConfigurations");
                writer.WriteStartArray();
            ...
            if (Optional.IsDefined(PremiumSKU))
            {
                if (PremiumSKU != null)
                {
                    writer.WritePropertyName("premiumSKU");
        ...
        internal static TelephonyChannelProperties DeserializeTelephonyChannelProperties(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("apiConfigurations"))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        property.ThrowNonNullablePropertyIsNull();
                ...
                if (property.NameEquals("premiumSKU"))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        premiumSKU = null;
