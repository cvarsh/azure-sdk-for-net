...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class ChannelSettings
    {
        ...
        internal ChannelSettings(string extensionKey1, string extensionKey2, IList<Site> sites, string channelId, string channelDisplayName, string botId, Uri botIconUri, bool? isEnabled, bool? disableLocalAuth, bool? requireTermsAgreement)
        {
