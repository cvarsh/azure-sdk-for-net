...
{
    /// <summary> The PurviewScanResult service client. </summary>
    public partial class PurviewScanResultClient
    {
        ...
        /// <summary> Initializes a new instance of PurviewScanResultClient for mocking. </summary>
        protected PurviewScanResultClient()
        {
        }

        /// <summary> Initializes a new instance of PurviewScanResultClient. </summary>
        /// <param name="endpoint"> The catalog endpoint of your Purview account. Example: https://{accountName}.purview.azure.com. </param>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public PurviewScanResultClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewCatalogClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public PurviewScanResultClient(Uri endpoint, TokenCredential credential, PurviewCatalogClientOptions options)
        {
        ...
        /// var client = new PurviewScanResultClient(endpoint, credential);
        /// 
        ...
        public virtual async Task<Response> RunScanAsync(string dataSourceName, string scanName, string runId, string scanLevel = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("PurviewScanResultClient.RunScan");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> CancelScanAsync(string dataSourceName, string scanName, string runId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("PurviewScanResultClient.CancelScan");
            scope.Start();
            try
            {
        ...
        /// <example>
        /// This sample shows how to call GetScanHistoryAsync with required parameters and parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var endpoint = new Uri("<https://my-service.azure.com>");
        /// var client = new PurviewScanResultClient(endpoint, credential);
        /// 
        /// await foreach (var data in client.GetScanHistoryAsync("<dataSourceName>", "<scanName>"))
        /// {
        ...
        /// 
        /// </remarks>
        public virtual AsyncPageable<BinaryData> GetScanHistoryAsync(string dataSourceName, string scanName, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(dataSourceName, nameof(dataSourceName));
            Argument.AssertNotNullOrEmpty(scanName, nameof(scanName));

            return GetScanHistoryImplementationAsync("PurviewScanResultClient.GetScanHistory", dataSourceName, scanName, context);
        }

        private AsyncPageable<BinaryData> GetScanHistoryImplementationAsync(string diagnosticsScopeName, string dataSourceName, string scanName, RequestContext context)
        {
            ...
            async IAsyncEnumerable<Page<BinaryData>> CreateEnumerableAsync(string nextLink, int? pageSizeHint, [EnumeratorCancellation] CancellationToken cancellationToken = default)
            {
                do
                {
                    var message = string.IsNullOrEmpty(nextLink)
                        ? CreateGetScanHistoryRequest(dataSourceName, scanName, context)
                        : CreateGetScanHistoryNextPageRequest(nextLink, dataSourceName, scanName, context);
        ...
        /// <example>
        /// This sample shows how to call GetScanHistory with required parameters and parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var endpoint = new Uri("<https://my-service.azure.com>");
        /// var client = new PurviewScanResultClient(endpoint, credential);
        /// 
        /// foreach (var data in client.GetScanHistory("<dataSourceName>", "<scanName>"))
        /// {
        ///     JsonElement result = JsonDocument.Parse(data.ToStream()).RootElement;
        ///     Console.WriteLine(result.GetProperty("parentId").ToString());
        ///     Console.WriteLine(result.GetProperty("id").ToString());
        ...
        /// 
        /// </remarks>
        public virtual Pageable<BinaryData> GetScanHistory(string dataSourceName, string scanName, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(dataSourceName, nameof(dataSourceName));
            Argument.AssertNotNullOrEmpty(scanName, nameof(scanName));

            return GetScanHistoryImplementation("PurviewScanResultClient.GetScanHistory", dataSourceName, scanName, context);
        }

        private Pageable<BinaryData> GetScanHistoryImplementation(string diagnosticsScopeName, string dataSourceName, string scanName, RequestContext context)
        {
        ...
        internal HttpMessage CreateGetScanHistoryRequest(string dataSourceName, string scanName, RequestContext context)
        {
        ...
        internal HttpMessage CreateGetScanHistoryNextPageRequest(string nextLink, string dataSourceName, string scanName, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
