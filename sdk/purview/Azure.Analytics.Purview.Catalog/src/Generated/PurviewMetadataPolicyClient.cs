...
namespace Azure.Analytics.Purview.Catalog
{
    ...
    public partial class PurviewMetadataPolicyClient
    {
        ...
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <example>
        /// This sample shows how to call GetPurviewMetadataPolicyAsync with required parameters and parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var endpoint = new Uri("<https://my-service.azure.com>");
        /// var client = new PurviewMetadataPolicyClient(endpoint, credential);
        /// 
        /// Response response = await client.GetPurviewMetadataPolicyAsync("<policyId>");
        /// 
        /// JsonElement result = JsonDocument.Parse(response.ContentStream).RootElement;
        /// Console.WriteLine(result.GetProperty("name").ToString());
        /// Console.WriteLine(result.GetProperty("id").ToString());
        ...
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <example>
        /// This sample shows how to call GetPurviewMetadataPolicy with required parameters and parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var endpoint = new Uri("<https://my-service.azure.com>");
        /// var client = new PurviewMetadataPolicyClient(endpoint, credential);
        /// 
        /// Response response = client.GetPurviewMetadataPolicy("<policyId>");
        /// 
        /// JsonElement result = JsonDocument.Parse(response.ContentStream).RootElement;
        /// Console.WriteLine(result.GetProperty("name").ToString());
        /// Console.WriteLine(result.GetProperty("id").ToString());
        ...
        /// }
        /// ]]></code>
        /// This sample shows how to call GetAllAsync with all parameters, and how to parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var endpoint = new Uri("<https://my-service.azure.com>");
        /// var client = new PurviewMetadataPolicyClient(endpoint, credential);
        /// 
        /// await foreach (var data in client.GetAllAsync("<collectionName>"))
        /// {
        ///     JsonElement result = JsonDocument.Parse(data.ToStream()).RootElement;
        ///     Console.WriteLine(result.GetProperty("name").ToString());
        ///     Console.WriteLine(result.GetProperty("id").ToString());
        ...
        /// }
        /// ]]></code>
        /// This sample shows how to call GetAll with all parameters, and how to parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var endpoint = new Uri("<https://my-service.azure.com>");
        /// var client = new PurviewMetadataPolicyClient(endpoint, credential);
        /// 
        /// foreach (var data in client.GetAll("<collectionName>"))
        /// {
        ///     JsonElement result = JsonDocument.Parse(data.ToStream()).RootElement;
        ///     Console.WriteLine(result.GetProperty("name").ToString());
        ///     Console.WriteLine(result.GetProperty("id").ToString());
