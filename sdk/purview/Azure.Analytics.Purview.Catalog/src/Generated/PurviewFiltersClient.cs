...
{
    /// <summary> The PurviewFilters service client. </summary>
    public partial class PurviewFiltersClient
    {
        ...
        /// <summary> Initializes a new instance of PurviewFiltersClient for mocking. </summary>
        protected PurviewFiltersClient()
        {
        }

        /// <summary> Initializes a new instance of PurviewFiltersClient. </summary>
        /// <param name="endpoint"> The catalog endpoint of your Purview account. Example: https://{accountName}.purview.azure.com. </param>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public PurviewFiltersClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewCatalogClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public PurviewFiltersClient(Uri endpoint, TokenCredential credential, PurviewCatalogClientOptions options)
        {
        ...
        /// <example>
        /// This sample shows how to call GetPurviewFilterAsync with required parameters and parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var endpoint = new Uri("<https://my-service.azure.com>");
        /// var client = new PurviewFiltersClient(endpoint, credential);
        /// 
        /// Response response = await client.GetPurviewFilterAsync("<dataSourceName>", "<scanName>");
        /// 
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> GetPurviewFilterAsync(string dataSourceName, string scanName, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(dataSourceName, nameof(dataSourceName));
            Argument.AssertNotNullOrEmpty(scanName, nameof(scanName));

            using var scope = ClientDiagnostics.CreateScope("PurviewFiltersClient.GetPurviewFilter");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetPurviewFilterRequest(dataSourceName, scanName, context);
        ...
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <example>
        /// This sample shows how to call GetPurviewFilter with required parameters and parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var endpoint = new Uri("<https://my-service.azure.com>");
        /// var client = new PurviewFiltersClient(endpoint, credential);
        /// 
        /// Response response = client.GetPurviewFilter("<dataSourceName>", "<scanName>");
        /// 
        /// JsonElement result = JsonDocument.Parse(response.ContentStream).RootElement;
        /// Console.WriteLine(result.GetProperty("properties").GetProperty("excludeUriPrefixes")[0].ToString());
        /// Console.WriteLine(result.GetProperty("properties").GetProperty("includeUriPrefixes")[0].ToString());
        ...
        /// 
        /// </remarks>
        public virtual Response GetPurviewFilter(string dataSourceName, string scanName, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(dataSourceName, nameof(dataSourceName));
            Argument.AssertNotNullOrEmpty(scanName, nameof(scanName));
        ...
        public virtual async Task<Response> CreateOrUpdateAsync(string dataSourceName, string scanName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("PurviewFiltersClient.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        internal HttpMessage CreateGetPurviewFilterRequest(string dataSourceName, string scanName, RequestContext context)
        {
