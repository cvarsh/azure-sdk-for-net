...
{
    /// <summary> The PurviewTriggers service client. </summary>
    public partial class PurviewTriggersClient
    {
        ...
        /// <summary> Initializes a new instance of PurviewTriggersClient for mocking. </summary>
        protected PurviewTriggersClient()
        {
        }

        /// <summary> Initializes a new instance of PurviewTriggersClient. </summary>
        /// <param name="endpoint"> The catalog endpoint of your Purview account. Example: https://{accountName}.purview.azure.com. </param>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public PurviewTriggersClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewCatalogClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public PurviewTriggersClient(Uri endpoint, TokenCredential credential, PurviewCatalogClientOptions options)
        {
        ...
        /// var client = new PurviewTriggersClient(endpoint, credential);
        /// 
        ...
        public virtual async Task<Response> GetTriggerAsync(string dataSourceName, string scanName, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("PurviewTriggersClient.GetTrigger");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> CreateTriggerAsync(string dataSourceName, string scanName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("PurviewTriggersClient.CreateTrigger");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> DeleteTriggerAsync(string dataSourceName, string scanName, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("PurviewTriggersClient.DeleteTrigger");
            scope.Start();
            try
            {
