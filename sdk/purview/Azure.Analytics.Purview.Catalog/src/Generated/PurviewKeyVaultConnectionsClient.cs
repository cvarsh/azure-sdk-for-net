...
{
    /// <summary> The PurviewKeyVaultConnections service client. </summary>
    public partial class PurviewKeyVaultConnectionsClient
    {
        ...
        /// <summary> Initializes a new instance of PurviewKeyVaultConnectionsClient for mocking. </summary>
        protected PurviewKeyVaultConnectionsClient()
        {
        }

        /// <summary> Initializes a new instance of PurviewKeyVaultConnectionsClient. </summary>
        /// <param name="endpoint"> The catalog endpoint of your Purview account. Example: https://{accountName}.purview.azure.com. </param>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public PurviewKeyVaultConnectionsClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewCatalogClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public PurviewKeyVaultConnectionsClient(Uri endpoint, TokenCredential credential, PurviewCatalogClientOptions options)
        {
        ...
        /// <example>
        /// This sample shows how to call GetPurviewKeyVaultConnectionAsync with required parameters and parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var endpoint = new Uri("<https://my-service.azure.com>");
        /// var client = new PurviewKeyVaultConnectionsClient(endpoint, credential);
        /// 
        /// Response response = await client.GetPurviewKeyVaultConnectionAsync("<keyVaultName>");
        /// 
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> GetPurviewKeyVaultConnectionAsync(string keyVaultName, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(keyVaultName, nameof(keyVaultName));

            using var scope = ClientDiagnostics.CreateScope("PurviewKeyVaultConnectionsClient.GetPurviewKeyVaultConnection");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetPurviewKeyVaultConnectionRequest(keyVaultName, context);
        ...
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <example>
        /// This sample shows how to call GetPurviewKeyVaultConnection with required parameters and parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var endpoint = new Uri("<https://my-service.azure.com>");
        /// var client = new PurviewKeyVaultConnectionsClient(endpoint, credential);
        /// 
        /// Response response = client.GetPurviewKeyVaultConnection("<keyVaultName>");
        /// 
        /// JsonElement result = JsonDocument.Parse(response.ContentStream).RootElement;
        /// Console.WriteLine(result.GetProperty("properties").GetProperty("baseUrl").ToString());
        /// Console.WriteLine(result.GetProperty("properties").GetProperty("description").ToString());
        ...
        /// 
        /// </remarks>
        public virtual Response GetPurviewKeyVaultConnection(string keyVaultName, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(keyVaultName, nameof(keyVaultName));
        ...
        public virtual async Task<Response> CreateAsync(string keyVaultName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("PurviewKeyVaultConnectionsClient.Create");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> DeleteAsync(string keyVaultName, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("PurviewKeyVaultConnectionsClient.Delete");
            scope.Start();
            try
            {
        ...
        {
            return GetAllImplementationAsync("PurviewKeyVaultConnectionsClient.GetAll", context);
        }
        ...
        {
            return GetAllImplementation("PurviewKeyVaultConnectionsClient.GetAll", context);
        }
        ...
        internal HttpMessage CreateGetPurviewKeyVaultConnectionRequest(string keyVaultName, RequestContext context)
        {
