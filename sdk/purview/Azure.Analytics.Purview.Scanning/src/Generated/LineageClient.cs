...
namespace Azure.Analytics.Purview.Scanning
{
    ...
    public partial class LineageClient
    {
        ...
        /// var client = new LineageClient(endpoint, credential);
        /// 
        /// Response response = await client.GetLineageByUniqueAttributeAsync("<typeName>", "<direction>", 1234, 1234, true, true, "<attrQualifiedName>");
        /// 
        /// JsonElement result = JsonDocument.Parse(response.ContentStream).RootElement;
        /// Console.WriteLine(result.GetProperty("baseEntityGuid").ToString());
        /// Console.WriteLine(result.GetProperty("guidEntityMap").GetProperty("<test>").GetProperty("classificationNames")[0].ToString());
        ...
        /// var client = new LineageClient(endpoint, credential);
        /// 
        /// Response response = client.GetLineageByUniqueAttribute("<typeName>", "<direction>", 1234, 1234, true, true, "<attrQualifiedName>");
        /// 
        /// JsonElement result = JsonDocument.Parse(response.ContentStream).RootElement;
        /// Console.WriteLine(result.GetProperty("baseEntityGuid").ToString());
        /// Console.WriteLine(result.GetProperty("guidEntityMap").GetProperty("<test>").GetProperty("classificationNames")[0].ToString());
