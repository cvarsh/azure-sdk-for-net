...
namespace Azure.Analytics.Purview.Administration
{
    ...
    public partial class ViewSchemaClient
    {
        ...
        public ViewSchemaClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewAccountClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public ViewSchemaClient(Uri endpoint, TokenCredential credential, PurviewAccountClientOptions options)
        {
