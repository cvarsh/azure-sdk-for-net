...
namespace Azure.Analytics.Purview.Share
{
    ...
    public partial class AssetsClient
    {
        ...
        public AssetsClient(string endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewPDSClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public AssetsClient(string endpoint, TokenCredential credential, PurviewPDSClientOptions options)
        {
