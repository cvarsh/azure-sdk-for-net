...
namespace Azure.Analytics.Purview.Share
{
    ...
    public partial class AssetMappingsClient
    {
        ...
        public AssetMappingsClient(string endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewPDSClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public AssetMappingsClient(string endpoint, TokenCredential credential, PurviewPDSClientOptions options)
        {
