...
namespace Azure.Analytics.Purview.Share
{
    ...
    public partial class ScanRulesetsClient
    {
        ...
        public ScanRulesetsClient(string endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewPDSClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public ScanRulesetsClient(string endpoint, TokenCredential credential, PurviewPDSClientOptions options)
        {
