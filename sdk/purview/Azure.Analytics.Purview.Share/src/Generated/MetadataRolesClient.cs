...
namespace Azure.Analytics.Purview.Share
{
    ...
    public partial class MetadataRolesClient
    {
        ...
        public MetadataRolesClient(string endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewPDSClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public MetadataRolesClient(string endpoint, TokenCredential credential, PurviewPDSClientOptions options)
        {
