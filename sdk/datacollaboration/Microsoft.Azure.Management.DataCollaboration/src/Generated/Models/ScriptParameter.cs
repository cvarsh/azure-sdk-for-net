...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class ScriptParameter
    {
        ...
        public ScriptParameter(string name, string description = default(string), string parameterId = default(string))
        {
        ...
        /// <summary>
        /// Gets or sets parameter name as it appears in the script
        /// </summary>
