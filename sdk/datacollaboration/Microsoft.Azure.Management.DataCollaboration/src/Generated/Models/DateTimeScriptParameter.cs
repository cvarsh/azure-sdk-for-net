...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class DateTimeScriptParameter : ScriptParameter
    {
        /// <summary>
        /// Initializes a new instance of the DateTimeScriptParameter class.
        /// </summary>
        public DateTimeScriptParameter()
        {
            CustomInit();
        }
        ...
        public DateTimeScriptParameter(string name, string description = default(string), string parameterId = default(string), System.DateTime? defaultValue = default(System.DateTime?))
