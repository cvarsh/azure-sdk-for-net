...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class ScriptExecutionSubstepReference : SubstepReference
    {
        /// <summary>
        /// Initializes a new instance of the ScriptExecutionSubstepReference
        /// class.
        /// </summary>
        public ScriptExecutionSubstepReference()
        {
            CustomInit();
        }
        ...
        public ScriptExecutionSubstepReference(string pipelineStepName = default(string), string pipelineSubstepId = default(string), string outputBindingKey = default(string))
