...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class Pipeline : ProxyDto
    {
        ...
        /// <param name="scriptParameters">List of pipeline level script
        /// parameters</param>
        public Pipeline(string id = default(string), string name = default(string), SystemData systemData = default(SystemData), string type = default(string), string description = default(string), string pipelineId = default(string), string provisioningState = default(string), IList<ScriptParameter> scriptParameters = default(IList<ScriptParameter>))
        ...
        /// <summary>
        /// Gets or sets list of pipeline level script parameters
        /// </summary>
