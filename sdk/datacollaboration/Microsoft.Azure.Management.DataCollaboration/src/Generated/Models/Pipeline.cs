...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class Pipeline : ProxyDto
    {
        ...
        /// <param name="computationParameters">List of pipeline level
        ...
        /// <param name="stepParameters">List of parameter to override step
        /// parameters</param>
        public Pipeline(string id = default(string), string name = default(string), SystemData systemData = default(SystemData), string type = default(string), IList<ComputationParameter> computationParameters = default(IList<ComputationParameter>), string description = default(string), string pipelineId = default(string), string provisioningState = default(string), IList<PipelineStepParameter> stepParameters = default(IList<PipelineStepParameter>))
        ...
        /// <summary>
        /// Gets or sets list of pipeline level computation parameters
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets list of parameter to override step parameters
        /// </summary>
        [JsonProperty(PropertyName = "properties.stepParameters")]
        public IList<PipelineStepParameter> StepParameters { get; set; }
