...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class PipelineStepRun : ProxyDto
    {
        ...
        public PipelineStepRun(string id = default(string), string name = default(string), SystemData systemData = default(SystemData), string type = default(string), int? durationMs = default(int?), System.DateTime? endTime = default(System.DateTime?), string errorMessage = default(string), IList<PipelineStepExecutionParameter> executionParameters = default(IList<PipelineStepExecutionParameter>), string pipelineStepName = default(string), string pipelineStepRunStatus = default(string), IList<PipelineSubstep> pipelineSubsteps = default(IList<PipelineSubstep>), System.DateTime? startTime = default(System.DateTime?))
        ...
        /// </summary>
        [JsonProperty(PropertyName = "properties.executionParameters")]
        public IList<PipelineStepExecutionParameter> ExecutionParameters { get; private set; }
