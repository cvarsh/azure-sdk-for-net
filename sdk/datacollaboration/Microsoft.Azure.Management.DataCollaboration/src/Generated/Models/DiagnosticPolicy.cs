...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class DiagnosticPolicy : Policy
    {
        ...
        public DiagnosticPolicy(string logLevel, string id = default(string), string name = default(string), SystemData systemData = default(SystemData), string type = default(string), string description = default(string))
