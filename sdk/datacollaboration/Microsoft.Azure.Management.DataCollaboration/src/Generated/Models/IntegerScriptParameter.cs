...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class IntegerScriptParameter : ScriptParameter
    {
        /// <summary>
        /// Initializes a new instance of the IntegerScriptParameter class.
        /// </summary>
        public IntegerScriptParameter()
        {
            CustomInit();
        }
        ...
        public IntegerScriptParameter(string name, string description = default(string), string parameterId = default(string), int? defaultValue = default(int?))
