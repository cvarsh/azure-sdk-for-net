...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    /// </summary>
    [Newtonsoft.Json.JsonObject("ContainerInstanceContainerGroup")]
    [Rest.Serialization.JsonTransformation]
    public partial class ContainerInstanceContainerGroupPipelineStep : PipelineStep
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ContainerInstanceContainerGroupPipelineStep class.
        /// </summary>
        public ContainerInstanceContainerGroupPipelineStep()
        {
            CustomInit();
        }
        ...
        /// <param name="containerInstanceId">The Container Instance that will
        ...
        /// parameters</param>
        public ContainerInstanceContainerGroupPipelineStep(string computationId, int computationRevision, IList<ComputationDataAssetBinding> computationSinkBindings, IList<ComputationDataAssetBinding> computationSourceBindings, string id = default(string), string name = default(string), SystemData systemData = default(SystemData), string type = default(string), string computationExecutionTimeout = default(string), IList<ComputationParameterBinding> computationParameterBindings = default(IList<ComputationParameterBinding>), IList<ComputationParameter> computationParameters = default(IList<ComputationParameter>), string containerInstanceId = default(string), IList<string> dependencies = default(IList<string>), IList<DiagnosticsLog> diagnosticsLogBindings = default(IList<DiagnosticsLog>), IList<PipelineStepParameter> parameters = default(IList<PipelineStepParameter>))
        ...
        public IList<ComputationDataAssetBinding> ComputationSinkBindings { get; set; }
        ...
        public IList<ComputationDataAssetBinding> ComputationSourceBindings { get; set; }

        /// <summary>
        /// Gets or sets the Container Instance that will execute this step
        /// </summary>
        [JsonProperty(PropertyName = "properties.containerInstanceId")]
        ...
        public virtual void Validate()
        {
            ...
            {
                foreach (var element2 in DiagnosticsLogBindings)
                {
                    if (element2 != null)
                    {
                        element2.Validate();
            ...
            if (Parameters != null)
            {
                foreach (var element3 in Parameters)
                {
                    if (element3 != null)
                    {
                        element3.Validate();
