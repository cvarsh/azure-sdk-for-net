...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class ContainerInstanceContainerGroupReference : ComputationReference
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ContainerInstanceContainerGroupReference class.
        /// </summary>
        public ContainerInstanceContainerGroupReference()
        {
            CustomInit();
        }
        ...
        public ContainerInstanceContainerGroupReference(string id = default(string), string name = default(string), SystemData systemData = default(SystemData), string type = default(string), string computationId = default(string), string computationKind = default(string), string computationReferenceId = default(string), string displayName = default(string), string ownerId = default(string), IList<ComputationParameter> parameters = default(IList<ComputationParameter>), ContainerInstanceContainerGroupReferencePlaceholderInfo placeholderInfo = default(ContainerInstanceContainerGroupReferencePlaceholderInfo), string placeholderState = default(string), int? revision = default(int?), IList<string> sinks = default(IList<string>), IList<string> sources = default(IList<string>))
        ...
        public ContainerInstanceContainerGroupReferencePlaceholderInfo PlaceholderInfo { get; set; }
