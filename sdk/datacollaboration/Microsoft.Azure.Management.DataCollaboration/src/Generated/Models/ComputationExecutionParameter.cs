...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    /// </summary>
    public partial class ComputationExecutionParameter
    {
        /// <summary>
        /// Initializes a new instance of the ComputationExecutionParameter
        /// class.
        /// </summary>
        public ComputationExecutionParameter()
        {
            CustomInit();
        }
        ...
        public ComputationExecutionParameter(string name = default(string), string parameterType = default(string), string resolvedBy = default(string), string value = default(string))
        {
            Name = name;
