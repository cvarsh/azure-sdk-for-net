...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class ContainerPort
    {
        ...
        /// Possible values
        /// include: 'TCP', 'UDP'. Possible values include: 'TCP',
        /// 'UDP'</param>
        public ContainerPort(int? port = default(int?), string protocol = default(string))
        {
            Port = port;
            Protocol = protocol;
            CustomInit();
        ...
        /// include: 'TCP', 'UDP'. Possible values include: 'TCP', 'UDP'
        /// </summary>
