...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    /// </summary>
    public partial class DataAssetReferencePlaceholderInfo
    {
        /// <summary>
        /// Initializes a new instance of the DataAssetReferencePlaceholderInfo
        /// class.
        /// </summary>
        public DataAssetReferencePlaceholderInfo()
        {
            CustomInit();
        }
        ...
        public DataAssetReferencePlaceholderInfo(string assignerId, string displayName, string description = default(string))
        {
