...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class Invitation : ProxyDto
    {
        ...
        /// <param name="participantPlaceholderId">The participant placeholder
        /// Id which this invitation is meant to assign</param>
        ...
        /// resource</param>
        public Invitation(string id = default(string), string name = default(string), SystemData systemData = default(SystemData), string type = default(string), string invitationId = default(string), string invitationStatus = default(string), string participantPlaceholderId = default(string), System.DateTime? respondedAt = default(System.DateTime?), System.DateTime? sentAt = default(System.DateTime?), string targetActiveDirectoryId = default(string), string targetEmail = default(string), string targetObjectId = default(string), string userEmail = default(string), string userName = default(string))
            : base(id, name, systemData, type)
        {
            InvitationId = invitationId;
            InvitationStatus = invitationStatus;
            ParticipantPlaceholderId = participantPlaceholderId;
        ...
        /// <summary>
        /// Gets or sets the participant placeholder Id which this invitation
        /// is meant to assign
        /// </summary>
        [JsonProperty(PropertyName = "properties.participantPlaceholderId")]
        public string ParticipantPlaceholderId { get; set; }
