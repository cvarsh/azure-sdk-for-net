...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    /// within the specified Azure computation.
    /// </summary>
    [Newtonsoft.Json.JsonObject("ContainerInstanceContainerGroup")]
    [Rest.Serialization.JsonTransformation]
    public partial class ContainerInstanceContainerGroupResourceReference : ResourceReference
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ContainerInstanceContainerGroupResourceReference class.
        /// </summary>
        public ContainerInstanceContainerGroupResourceReference()
        {
            CustomInit();
        }
        ...
        public ContainerInstanceContainerGroupResourceReference(ResourceReferenceParticipantDetails participantDetails = default(ResourceReferenceParticipantDetails), string resourceId = default(string), string resourceName = default(string), string resourceType = default(string), ResourceReferenceSystemData systemData = default(ResourceReferenceSystemData), string computationId = default(string), string computationKind = default(string), IList<ComputationParameter> parameters = default(IList<ComputationParameter>), int? revision = default(int?), IList<string> sinks = default(IList<string>), IList<string> sources = default(IList<string>))
