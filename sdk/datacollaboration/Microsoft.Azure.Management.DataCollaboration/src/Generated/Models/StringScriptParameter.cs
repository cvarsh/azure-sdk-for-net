...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class StringScriptParameter : ScriptParameter
    {
        /// <summary>
        /// Initializes a new instance of the StringScriptParameter class.
        /// </summary>
        public StringScriptParameter()
        {
            CustomInit();
        }
        ...
        public StringScriptParameter(string name, string description = default(string), string parameterId = default(string), string defaultValue = default(string))
