...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class IntegerComputationParameter : ComputationParameter
    {
        /// <summary>
        /// Initializes a new instance of the IntegerComputationParameter
        /// class.
        /// </summary>
        public IntegerComputationParameter()
        {
            CustomInit();
        }
        ...
        public IntegerComputationParameter(string name, string description = default(string), string parameterId = default(string), int? defaultValue = default(int?))
