...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    /// </summary>
    public partial class Computation : ProxyDto
    {
        /// <summary>
        ...
        public Computation(string id = default(string), string name = default(string), SystemData systemData = default(SystemData), string type = default(string))
