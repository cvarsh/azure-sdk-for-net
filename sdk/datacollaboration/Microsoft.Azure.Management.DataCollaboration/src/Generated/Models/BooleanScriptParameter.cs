...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class BooleanScriptParameter : ScriptParameter
    {
        /// <summary>
        /// Initializes a new instance of the BooleanScriptParameter class.
        /// </summary>
        public BooleanScriptParameter()
        {
            CustomInit();
        }
        ...
        public BooleanScriptParameter(string name, string description = default(string), string parameterId = default(string), bool? defaultValue = default(bool?))
