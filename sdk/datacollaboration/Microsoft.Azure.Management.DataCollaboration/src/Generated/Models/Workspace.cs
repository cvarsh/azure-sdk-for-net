...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class Workspace : DefaultDto
    {
        ...
        /// resource</param>
        public Workspace(Identity identity, string id = default(string), string name = default(string), SystemData systemData = default(SystemData), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string displayName = default(string), string provisioningState = default(string), string userEmail = default(string), string userName = default(string))
