...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    public partial class DataAssetResourceReference : ResourceReference
    {
        ...
        /// reference</param>
        public DataAssetResourceReference(ResourceReferenceParticipantDetails participantDetails = default(ResourceReferenceParticipantDetails), string resourceId = default(string), string resourceName = default(string), string resourceType = default(string), ResourceReferenceSystemData systemData = default(ResourceReferenceSystemData), string dataAssetId = default(string), string description = default(string))
