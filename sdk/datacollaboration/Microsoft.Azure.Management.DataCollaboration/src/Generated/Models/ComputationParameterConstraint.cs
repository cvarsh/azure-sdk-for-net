...
namespace Microsoft.Azure.Management.DataCollaboration.Models
{
    ...
    /// specific computation parameter.
    /// </summary>
    [Newtonsoft.Json.JsonObject("ComputationParameter")]
    [Rest.Serialization.JsonTransformation]
    public partial class ComputationParameterConstraint : Constraint
    {
        /// <summary>
        /// Initializes a new instance of the ComputationParameterConstraint
        /// class.
        /// </summary>
        public ComputationParameterConstraint()
        {
            CustomInit();
        }
        ...
        /// follow</param>
        public ComputationParameterConstraint(string parameterName, string id = default(string), string name = default(string), SystemData systemData = default(SystemData), string type = default(string), string description = default(string), bool? isParameterRequired = default(bool?), string parameterType = default(string), ComputationParameterValidationRule validationRule = default(ComputationParameterValidationRule))
        ...
        public ComputationParameterValidationRule ValidationRule { get; set; }
