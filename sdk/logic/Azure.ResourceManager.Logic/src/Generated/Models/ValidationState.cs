...
{
    /// <summary> The validation state. </summary>
    public readonly partial struct ValidationState : IEquatable<ValidationState>
    {
        ...
        private const string SucceededWithWarningValue = "SucceededWithWarning";
        private const string SucceededValue = "Succeeded";

        /// <summary> NotSpecified. </summary>
        public static ValidationState NotSpecified { get; } = new ValidationState(NotSpecifiedValue);
        /// <summary> Failed. </summary>
        public static ValidationState Failed { get; } = new ValidationState(FailedValue);
        /// <summary> SucceededWithWarning. </summary>
        public static ValidationState SucceededWithWarning { get; } = new ValidationState(SucceededWithWarningValue);
