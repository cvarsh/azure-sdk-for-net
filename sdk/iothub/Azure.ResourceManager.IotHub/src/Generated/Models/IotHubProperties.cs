...
namespace Azure.ResourceManager.IotHub.Models
{
    ...
    public partial class IotHubProperties
    {
        ...
        /// <param name="allowDataPlanePreviewFeatures"> When this property is set to true, the hub receives all data plane preview features at all times. </param>
        internal IotHubProperties(IList<SharedAccessSignatureAuthorizationRule> authorizationPolicies, bool? disableLocalAuth, bool? disableDeviceSas, bool? disableModuleSas, bool? restrictOutboundNetworkAccess, IList<string> allowedFqdns, IotHubPublicNetworkAccess? publicNetworkAccess, IList<IotHubIPFilterRule> ipFilterRules, IotHubNetworkRuleSetProperties networkRuleSets, string minTlsVersion, IList<IotHubPrivateEndpointConnectionData> privateEndpointConnections, string provisioningState, string state, string hostName, IDictionary<string, EventHubCompatibleEndpointProperties> eventHubEndpoints, IotHubRoutingProperties routing, IDictionary<string, IotHubStorageEndpointProperties> storageEndpoints, IDictionary<string, MessagingEndpointProperties> messagingEndpoints, bool? enableFileUploadNotifications, CloudToDeviceProperties cloudToDevice, string comments, IotHubPropertiesDeviceStreams deviceStreams, IotHubCapability? features, EncryptionPropertiesDescription encryption, IReadOnlyList<IotHubLocationDescription> locations, bool? enableDataResidency, RootCertificateProperties rootCertificate, bool? allowDataPlanePreviewFeatures)
        {
            ...
            AllowDataPlanePreviewFeatures = allowDataPlanePreviewFeatures;
        }
        ...
        /// <summary> When this property is set to true, the hub receives all data plane preview features at all times. </summary>
        public bool? AllowDataPlanePreviewFeatures { get; set; }
    }
}
