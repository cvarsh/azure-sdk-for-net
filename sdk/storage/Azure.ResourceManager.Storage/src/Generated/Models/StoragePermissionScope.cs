...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class StoragePermissionScope
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="permissions"/> or <paramref name="resourceName"/> is null. </exception>
        public StoragePermissionScope(string permissions, PermissionScopeServiceName service, string resourceName)
        {
        ...
        public PermissionScopeServiceName Service { get; set; }
