...
namespace Azure.ResourceManager.PolicyInsights.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ComponentExpressionEvaluationDetails. </summary>
        ...
        internal ComponentExpressionEvaluationDetails(string result, string expression, string expressionKind, string path, BinaryData expressionValue, BinaryData targetValue, string @operator)
        {
            Result = result;
