...
namespace Microsoft.Azure.Management.PolicyInsights.Models
{
    ...
    public partial class ComponentExpressionEvaluationDetails
    {
        ...
        public ComponentExpressionEvaluationDetails(string result = default(string), string expression = default(string), string expressionKind = default(string), string path = default(string), object expressionValue = default(object), object targetValue = default(object), string operatorProperty = default(string))
        {
            Result = result;
        ...
        /// <summary>
        /// Gets property path if the expression is a field or an alias.
        /// </summary>
        ...
        /// <summary>
        /// Gets target value to be compared with the expression value.
        /// </summary>
        [JsonProperty(PropertyName = "targetValue")]
        public object TargetValue { get; private set; }

        /// <summary>
        /// Gets operator to compare the expression value and the target value.
        /// </summary>
        [JsonProperty(PropertyName = "operator")]
        public string OperatorProperty { get; private set; }
