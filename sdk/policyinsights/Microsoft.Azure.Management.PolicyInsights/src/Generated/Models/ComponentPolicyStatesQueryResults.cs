...
namespace Microsoft.Azure.Management.PolicyInsights.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ComponentPolicyStatesQueryResults
        /// class.
        /// </summary>
        public ComponentPolicyStatesQueryResults()
        {
            CustomInit();
        }
        ...
        public ComponentPolicyStatesQueryResults(string odatacontext = default(string), int? odatacount = default(int?), IList<ComponentPolicyState> value = default(IList<ComponentPolicyState>))
        {
        ...
        public IList<ComponentPolicyState> Value { get; set; }
