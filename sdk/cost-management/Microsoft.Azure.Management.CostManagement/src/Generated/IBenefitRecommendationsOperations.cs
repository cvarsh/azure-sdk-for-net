...
namespace Microsoft.Azure.Management.CostManagement
{
    ...
    {
        /// <summary>
        /// List of recommendations for purchasing benefit (reservation or
        /// savings plan).
        ...
        /// and default value 'P3Y'; kind with default value 'SavingsPlan';
        /// properties/armSkuName with allowed values ['Compute', 'SQL'] - if
        /// mentioned kind SavingsPlan is applied implicitly;
        /// properties/subscriptionId; properties/resourceGroup
        /// </param>
        /// <param name='orderby'>
        /// May be used to order the recommendations by: properties/armSkuName.
        /// This implicitly filters the results by the corresponding benefit
        /// type.
        /// </param>
        /// <param name='expand'>
