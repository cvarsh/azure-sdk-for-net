...
namespace Microsoft.Azure.Management.CostManagement
{
    ...
    public static partial class ScheduledActionsOperationsExtensions
    {
            ...
            /// Scheduled action name.
            /// </param>
            public static void Execute(this IScheduledActionsOperations operations, string name)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task ExecuteAsync(this IScheduledActionsOperations operations, string name, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Scheduled action name.
            /// </param>
            public static void ExecuteByScope(this IScheduledActionsOperations operations, string scope, string name)
            {
                operations.ExecuteByScopeAsync(scope, name).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task ExecuteByScopeAsync(this IScheduledActionsOperations operations, string scope, string name, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.ExecuteByScopeWithHttpMessagesAsync(scope, name, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
