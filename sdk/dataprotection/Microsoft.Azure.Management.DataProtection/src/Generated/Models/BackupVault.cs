...
namespace Microsoft.Azure.Management.DataProtection.Models
{
    ...
    public partial class BackupVault
    {
        ...
        public BackupVault(IList<StorageSetting> storageSettings, MonitoringSettings monitoringSettings = default(MonitoringSettings), string provisioningState = default(string), string resourceMoveState = default(string), ResourceMoveDetails resourceMoveDetails = default(ResourceMoveDetails), SecuritySettings securitySettings = default(SecuritySettings), bool? isVaultProtectedByResourceGuard = default(bool?))
        {
