      ...
      public static IEnumerable<Tuple<string, string, string>> ApiInfo_DataProtectionClient
      {
          get
          {
              return new Tuple<string, string, string>[]
              {
                ...
                new Tuple<string, string, string>("DataProtection", "BackupInstancesExtensionRouting", "2022-10-01-preview"),
                ...
                new Tuple<string, string, string>("DataProtection", "DeletedBackupInstances", "2022-10-01-preview"),
                new Tuple<string, string, string>("DataProtection", "DppResourceGuardProxy", "2022-10-01-preview"),
