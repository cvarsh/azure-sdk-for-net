...
namespace Microsoft.Azure.Management.Peering
{
    ...
    internal partial class RegisteredPrefixesOperations : IServiceOperations<PeeringManagementClient>, IRegisteredPrefixesOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<PeeringRegisteredPrefix>> ValidateWithHttpMessagesAsync(string resourceGroupName, string peeringName, string registeredPrefixName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Peering/peerings/{peeringName}/registeredPrefixes/{registeredPrefixName}/validate").ToString();
            _url = _url.Replace("{resourceGroupName}", System.Uri.EscapeDataString(resourceGroupName));
            _url = _url.Replace("{peeringName}", System.Uri.EscapeDataString(peeringName));
            _url = _url.Replace("{registeredPrefixName}", System.Uri.EscapeDataString(registeredPrefixName));
            _url = _url.Replace("{subscriptionId}", System.Uri.EscapeDataString(Client.SubscriptionId));
