...
namespace Microsoft.Azure.Management.ServiceFabricManagedClusters
{
    ...
    /// </summary>
    internal partial class OperationStatusOperations : IServiceOperations<ServiceFabricManagedClustersManagementClient>, IOperationStatusOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<LongRunningOperationResult>> GetWithHttpMessagesAsync(string location, string operationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<LongRunningOperationResult>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<LongRunningOperationResult>(_responseContent, Client.DeserializationSettings);
                }
