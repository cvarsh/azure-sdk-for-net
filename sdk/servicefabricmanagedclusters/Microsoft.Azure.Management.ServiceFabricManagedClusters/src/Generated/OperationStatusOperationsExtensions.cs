...
namespace Microsoft.Azure.Management.ServiceFabricManagedClusters
{
    ...
    public static partial class OperationStatusOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<LongRunningOperationResult> GetAsync(this IOperationStatusOperations operations, string location, string operationId, CancellationToken cancellationToken = default(CancellationToken))
            {
