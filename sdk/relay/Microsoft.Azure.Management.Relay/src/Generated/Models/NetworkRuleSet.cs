...
namespace Microsoft.Azure.Management.Relay.Models
{
    ...
    public partial class NetworkRuleSet : Resource
    {
        ...
        /// resource.</param>
        public NetworkRuleSet(string id = default(string), string name = default(string), string type = default(string), string defaultAction = default(string), string publicNetworkAccess = default(string), IList<NWRuleSetIpRules> ipRules = default(IList<NWRuleSetIpRules>), SystemData systemData = default(SystemData))
            : base(id, name, type)
        {
