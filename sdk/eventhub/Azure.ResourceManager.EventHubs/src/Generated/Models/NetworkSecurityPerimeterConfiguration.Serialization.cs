...
namespace Azure.ResourceManager.EventHubs.Models
{
    public partial class NetworkSecurityPerimeterConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static NetworkSecurityPerimeterConfiguration DeserializeNetworkSecurityPerimeterConfiguration(JsonElement element)
        {
            ...
            return new NetworkSecurityPerimeterConfiguration(id, name, type, systemData.Value, Optional.ToNullable(provisioningState), Optional.ToList(provisioningIssues), networkSecurityPerimeter.Value, resourceAssociation.Value, profile.Value);
        }
    }
}
