...
namespace Azure.ResourceManager.EventHubs
{
    ...
    public partial class EventHubsNamespaceResource : ArmResource
    {
        ...
        private readonly ClientDiagnostics _geoDRClientDiagnostics;
        private readonly GeoDRRestOperations _geoDRRestClient;
        ...
        internal EventHubsNamespaceResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _geoDRClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.EventHubs", ProviderConstants.DefaultProviderNamespace, Diagnostics);
            _geoDRRestClient = new GeoDRRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint);
        ...
        /// Operation Id: GeoDR_Failover
        /// </summary>
        /// <param name="primaryLocation"> Query parameter for the new primary location after failover. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="primaryLocation"/> is null. </exception>
        public virtual async Task<Response<EventHubsNamespaceResource>> FailoverGeoDRAsync(string primaryLocation, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(primaryLocation, nameof(primaryLocation));

            using var scope = _geoDRClientDiagnostics.CreateScope("EventHubsNamespaceResource.FailoverGeoDR");
            scope.Start();
            try
            {
                var response = await _geoDRRestClient.FailoverAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, primaryLocation, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new EventHubsNamespaceResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="primaryLocation"/> is null. </exception>
        public virtual Response<EventHubsNamespaceResource> FailoverGeoDR(string primaryLocation, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(primaryLocation, nameof(primaryLocation));
            ...
            try
            {
                var response = _geoDRRestClient.Failover(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, primaryLocation, cancellationToken);
                return Response.FromValue(new EventHubsNamespaceResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventHub/namespaces/{namespaceName}/networkSecurityPerimeterConfigurations
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventHub/namespaces/{namespaceName}/networkSecurityPerimeterConfigurations/{resourceAssociationName}/reconcile
        /// Operation Id: NetworkSecurityPerimeterConfigurations_CreateOrUpdate
        /// </summary>
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
