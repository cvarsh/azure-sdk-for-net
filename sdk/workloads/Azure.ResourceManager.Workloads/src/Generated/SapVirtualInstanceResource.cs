...
namespace Azure.ResourceManager.Workloads
{
    ...
    public partial class SapVirtualInstanceResource : ArmResource
    {
        ...
        private readonly SAPVirtualInstanceRestOperations _sapVirtualInstanceRestClient;
        ...
        internal SapVirtualInstanceResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _sapVirtualInstanceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Workloads", ProviderConstants.DefaultProviderNamespace, Diagnostics);
            _sapVirtualInstanceRestClient = new SAPVirtualInstanceRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint);
#if DEBUG
        ...
        /// <summary>
        /// Gets the last operation details of the VIS. Request body contains the list of operations whose details need to be fetched.
        /// <list type="bullet">
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/sapVirtualInstances/{sapVirtualInstanceName}/lastOperationDetails</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        /// <description>SAPVirtualInstance_LastOperationDetails</description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="content"> Get Last Operation Details Request body. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<LastOperationDetailsResult>> LastOperationDetailsSAPVirtualInstanceAsync(LastOperationDetailsContent content = null, CancellationToken cancellationToken = default)
        {
            using var scope = _sapVirtualInstanceClientDiagnostics.CreateScope("SapVirtualInstanceResource.LastOperationDetailsSAPVirtualInstance");
            scope.Start();
            try
            {
                var response = await _sapVirtualInstanceRestClient.LastOperationDetailsAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <param name="content"> Get Last Operation Details Request body. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<LastOperationDetailsResult> LastOperationDetailsSAPVirtualInstance(LastOperationDetailsContent content = null, CancellationToken cancellationToken = default)
        {
            using var scope = _sapVirtualInstanceClientDiagnostics.CreateScope("SapVirtualInstanceResource.LastOperationDetailsSAPVirtualInstance");
            scope.Start();
            try
            {
                var response = _sapVirtualInstanceRestClient.LastOperationDetails(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
