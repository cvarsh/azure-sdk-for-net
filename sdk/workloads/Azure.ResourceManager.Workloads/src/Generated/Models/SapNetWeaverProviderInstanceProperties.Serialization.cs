...
namespace Azure.ResourceManager.Workloads.Models
{
    public partial class SapNetWeaverProviderInstanceProperties : IUtf8JsonSerializable
    {
        ...
        internal static SapNetWeaverProviderInstanceProperties DeserializeSapNetWeaverProviderInstanceProperties(JsonElement element)
        {
            ...
            return new SapNetWeaverProviderInstanceProperties(providerType, sapSid.Value, sapHostname.Value, sapInstanceNr.Value, Optional.ToList(sapHostFileEntries), sapUsername.Value, sapPassword.Value, sapPasswordUri.Value, sapClientId.Value, sapPortNumber.Value, sapSslCertificateUri.Value, sslCertificateUri.Value, Optional.ToNullable(sslPreference));
        }
    }
}
