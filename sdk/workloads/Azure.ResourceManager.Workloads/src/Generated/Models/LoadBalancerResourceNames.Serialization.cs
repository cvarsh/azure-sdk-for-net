...
namespace Azure.ResourceManager.Workloads.Models
{
    public partial class LoadBalancerResourceNames : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WritePropertyName("backendPoolNames");
                writer.WriteStartArray();
            ...
            {
                writer.WritePropertyName("healthProbeNames");
                writer.WriteStartArray();
        ...
        internal static LoadBalancerResourceNames DeserializeLoadBalancerResourceNames(JsonElement element)
        {
            ...
            {
                if (property.NameEquals("loadBalancerName"))
                {
                    loadBalancerName = property.Value.GetString();
                    continue;
                }
                if (property.NameEquals("frontendIpConfigurationNames"))
                {
                ...
                if (property.NameEquals("backendPoolNames"))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        property.ThrowNonNullablePropertyIsNull();
                ...
                if (property.NameEquals("healthProbeNames"))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        property.ThrowNonNullablePropertyIsNull();
