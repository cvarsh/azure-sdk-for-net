    ...
    public partial class CacheRuleCollection : ArmCollection, IEnumerable<CacheRuleResource>, IAsyncEnumerable<CacheRuleResource>
    {
        ...
        public virtual async Task<ArmOperation<CacheRuleResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string cacheRuleName, CacheRuleData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ContainerRegistryArmOperation<CacheRuleResource>(new CacheRuleOperationSource(Client), _cacheRuleClientDiagnostics, Pipeline, _cacheRuleRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cacheRuleName, data).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<Response<CacheRuleResource>> GetAsync(string cacheRuleName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _cacheRuleRestClient.GetAsyncAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cacheRuleName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<CacheRuleResource> Get(string cacheRuleName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _cacheRuleRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cacheRuleName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new CacheRuleResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// Operation Id: CacheRules_ListAsync
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        {
            async Task<Page<CacheRuleResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _cacheRuleClientDiagnostics.CreateScope("CacheRuleCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _cacheRuleRestClient.ListAsyncAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new CacheRuleResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<CacheRuleResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _cacheRuleClientDiagnostics.CreateScope("CacheRuleCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _cacheRuleRestClient.ListAsyncNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new CacheRuleResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<CacheRuleResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _cacheRuleClientDiagnostics.CreateScope("CacheRuleCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _cacheRuleRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new CacheRuleResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<CacheRuleResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _cacheRuleClientDiagnostics.CreateScope("CacheRuleCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _cacheRuleRestClient.ListAsyncNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new CacheRuleResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string cacheRuleName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _cacheRuleRestClient.GetAsyncAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cacheRuleName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string cacheRuleName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _cacheRuleRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cacheRuleName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
