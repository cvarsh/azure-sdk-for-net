...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    {
        /// <summary> Initializes a new instance of CredentialHealth. </summary>
        ...
        internal CredentialHealth(CredentialHealthStatus? status, string errorCode, string errorMessage)
        {
            Status = status;
            ErrorCode = errorCode;
