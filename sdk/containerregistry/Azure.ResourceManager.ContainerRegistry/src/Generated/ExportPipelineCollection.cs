    ...
    public partial class ExportPipelineCollection : ArmCollection, IEnumerable<ExportPipelineResource>, IAsyncEnumerable<ExportPipelineResource>
    {
        ...
        public virtual async Task<ArmOperation<ExportPipelineResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string exportPipelineName, ExportPipelineData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ContainerRegistryArmOperation<ExportPipelineResource>(new ExportPipelineOperationSource(Client), _exportPipelineClientDiagnostics, Pipeline, _exportPipelineRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, exportPipelineName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
