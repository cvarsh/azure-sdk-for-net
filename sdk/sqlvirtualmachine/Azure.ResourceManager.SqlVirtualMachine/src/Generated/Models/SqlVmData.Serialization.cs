...
namespace Azure.ResourceManager.SqlVirtualMachine
{
    public partial class SqlVmData : IUtf8JsonSerializable
    {
        ...
        internal static SqlVmData DeserializeSqlVmData(JsonElement element)
        {
            ...
            Optional<TroubleshootStatus> troubleshootStatus = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("troubleshootStatus"))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                property0.ThrowNonNullablePropertyIsNull();
                            ...
                            troubleshootStatus = TroubleshootStatus.DeserializeTroubleshootStatus(property0.Value);
                            continue;
                        }
