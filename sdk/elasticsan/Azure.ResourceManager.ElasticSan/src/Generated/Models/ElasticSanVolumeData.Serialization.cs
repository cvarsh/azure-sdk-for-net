...
namespace Azure.ResourceManager.ElasticSan
{
    public partial class ElasticSanVolumeData : IUtf8JsonSerializable
    {
        ...
        internal static ElasticSanVolumeData DeserializeElasticSanVolumeData(JsonElement element)
        {
            ...
            return new ElasticSanVolumeData(id, name, type, systemData.Value, volumeId.Value, creationData.Value, Optional.ToNullable(sizeGiB), storageTarget.Value, Optional.ToDictionary(tags));
        }
    }
}
