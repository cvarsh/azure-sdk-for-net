...
namespace Azure.ResourceManager.ElasticSan.Models
{
    public partial class SanTierInfo
    {
        internal static SanTierInfo DeserializeSanTierInfo(JsonElement element)
        {
            ...
            return new SanTierInfo(Optional.ToNullable(maxSizeTiB), Optional.ToNullable(minSizeTiB), Optional.ToNullable(minIncrementSizeTiB), Optional.ToNullable(iopsPerBaseTiB), Optional.ToNullable(mbpsPerBaseTiB), Optional.ToNullable(maxMBps), Optional.ToNullable(maxVolumeGroupCount));
        }
    }
}
