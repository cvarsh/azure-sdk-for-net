...
namespace Azure.ResourceManager.AppConfiguration
{
    public partial class ConfigurationStoreData : IUtf8JsonSerializable
    {
        ...
        internal static ConfigurationStoreData DeserializeConfigurationStoreData(JsonElement element)
        {
            ...
            return new ConfigurationStoreData(id, name, type, systemData, tags, location, identity, sku, Optional.ToNullable(provisioningState), Optional.ToNullable(creationDate), endpoint.Value);
        }
    }
}
