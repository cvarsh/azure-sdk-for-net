...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.Storage.BlobMetadataUpdate event. </summary>
    public partial class StorageBlobMetadataUpdateEventData
    {
        ...
        internal StorageBlobMetadataUpdateEventData(string api, string clientRequestId, string requestId, string eTag, string contentType, long? contentLength, string blobType, string url, string sequencer, string identity, object storageDiagnostics)
        {
            Api = api;
