...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.ApiManagement.SelfHostedGateway.CertificateAuthority.Created event. </summary>
    public partial class ApiManagementSelfHostedGatewayCertificateAuthorityCreatedEventData
    {
        ...
        internal ApiManagementSelfHostedGatewayCertificateAuthorityCreatedEventData(string resourceUri)
        {
