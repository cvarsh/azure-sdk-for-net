...
{
    /// <summary> Schema of the Data property of an EventGridEvent for a Microsoft.ApiManagement.SelfHostedGateway.Created event. </summary>
    public partial class ApiManagementSelfHostedGatewayCreatedEventData
    {
        ...
        internal ApiManagementSelfHostedGatewayCreatedEventData(string resourceUri)
        {
