...
namespace Azure.ResourceManager.ServiceLinker
{
    ...
    internal partial class TenantResourceExtensionClient : ArmResource
    {
        ...
        {
            async Task<Page<ConfigurationNameItem>> FirstPageFunc(int? pageSizeHint)
            {
            ...
            async Task<Page<ConfigurationNameItem>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = ConfigurationNamesClientDiagnostics.CreateScope("TenantResourceExtensionClient.GetConfigurationNames");
                scope.Start();
                try
        ...
        {
            Page<ConfigurationNameItem> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = ConfigurationNamesClientDiagnostics.CreateScope("TenantResourceExtensionClient.GetConfigurationNames");
                scope.Start();
                try
            ...
            Page<ConfigurationNameItem> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = ConfigurationNamesClientDiagnostics.CreateScope("TenantResourceExtensionClient.GetConfigurationNames");
                scope.Start();
                try
