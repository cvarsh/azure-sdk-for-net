...
{
    internal partial class ManagementGroupGovernanceRulesExecuteStatusRestOperations
    {
        ...
        /// <summary> Initializes a new instance of ManagementGroupGovernanceRulesExecuteStatusRestOperations. </summary>
        ...
        public ManagementGroupGovernanceRulesExecuteStatusRestOperations(HttpPipeline pipeline, string applicationId, string managementGroupId, Uri endpoint = null, string apiVersion = default)
        {
        ...
        internal HttpMessage CreateGetRequest(string ruleId, string operationId)
        {
            ...
            uri.AppendPath("/execute/operationResults/", false);
        ...
        public async Task<Response<ExecuteRuleStatus>> GetAsync(string ruleId, string operationId, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="ruleId"/> or <paramref name="operationId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="ruleId"/> or <paramref name="operationId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<ExecuteRuleStatus> Get(string ruleId, string operationId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ruleId, nameof(ruleId));
            Argument.AssertNotNullOrEmpty(operationId, nameof(operationId));
