...
namespace Azure.ResourceManager.SecurityCenter
{
    internal partial class GovernanceRulesRestOperations
    {
        ...
        public GovernanceRulesRestOperations(HttpPipeline pipeline, string applicationId, string managementGroupId, Uri endpoint = null, string apiVersion = default)
        {
        ...
        /// <summary> Creates or update GovernanceRule on the given subscription. </summary>
        /// <param name="subscriptionId"> Azure subscription ID. </param>
        /// <param name="ruleId"> The GovernanceRule key - unique key for the standard GovernanceRule. </param>
        ...
        /// <summary> Execute a GovernanceRule on the given subscription. </summary>
        /// <param name="subscriptionId"> Azure subscription ID. </param>
        /// <param name="ruleId"> The GovernanceRule key - unique key for the standard GovernanceRule. </param>
        ...
        /// <summary> Execute a GovernanceRule on the given security connector. </summary>
        /// <param name="subscriptionId"> Azure subscription ID. </param>
        ...
        internal HttpMessage CreateRuleIdExecuteSingleManagementGroupRequest(string ruleId, ExecuteGovernanceRuleParams executeGovernanceRuleParams)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <summary> Execute GovernanceRule on the given management group. </summary>
        /// <param name="ruleId"> The GovernanceRule key - unique key for the standard GovernanceRule. </param>
        /// <param name="executeGovernanceRuleParams"> ExecuteGovernanceRule over a given scope. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        public async Task<Response> RuleIdExecuteSingleManagementGroupAsync(string ruleId, ExecuteGovernanceRuleParams executeGovernanceRuleParams = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ruleId, nameof(ruleId));

            using var message = CreateRuleIdExecuteSingleManagementGroupRequest(ruleId, executeGovernanceRuleParams);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 202:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="ruleId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="ruleId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response RuleIdExecuteSingleManagementGroup(string ruleId, ExecuteGovernanceRuleParams executeGovernanceRuleParams = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ruleId, nameof(ruleId));
