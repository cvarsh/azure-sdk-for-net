...
namespace Azure.ResourceManager.SecurityCenter
{
    internal partial class GovernanceRulesRestOperations
    {
        ...
        /// <summary> Creates or updates a governance rule on a subscription. </summary>
        /// <param name="subscriptionId"> Azure subscription ID. </param>
        /// <param name="ruleId"> The governance rule key - unique key for the standard governance rule (GUID). </param>
        ...
        /// <summary> Execute a governance rule on a subscription. </summary>
        /// <param name="subscriptionId"> Azure subscription ID. </param>
        /// <param name="ruleId"> The governance rule key - unique key for the standard governance rule (GUID). </param>
        ...
        /// <summary> Execute a governance rule on the given security connector. </summary>
        /// <param name="subscriptionId"> Azure subscription ID. </param>
        ...
        /// <summary> Execute governance rule on the given management group. </summary>
        /// <param name="ruleId"> The governance rule key - unique key for the standard governance rule (GUID). </param>
        /// <param name="executeGovernanceRuleParams"> Execute governance rule over a given scope. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
