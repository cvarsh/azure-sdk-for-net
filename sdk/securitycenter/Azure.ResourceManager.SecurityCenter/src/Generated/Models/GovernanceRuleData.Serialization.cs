...
namespace Azure.ResourceManager.SecurityCenter
{
    public partial class GovernanceRuleData : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WritePropertyName("excludedScopes");
            ...
            if (Optional.IsDefined(InheritRules))
            {
                writer.WritePropertyName("inheritRules");
                writer.WriteBooleanValue(InheritRules.Value);
            }
        ...
        internal static GovernanceRuleData DeserializeGovernanceRuleData(JsonElement element)
        {
            ...
            Optional<bool> inheritRules = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("excludedScopes"))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                property0.ThrowNonNullablePropertyIsNull();
                        ...
                        if (property0.NameEquals("inheritRules"))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                property0.ThrowNonNullablePropertyIsNull();
                            ...
                            inheritRules = property0.Value.GetBoolean();
                            continue;
                        }
            ...
            return new GovernanceRuleData(id, name, type, systemData.Value, Optional.ToNullable(tenantId), displayName.Value, description.Value, remediationTimeframe.Value, Optional.ToNullable(isGracePeriod), Optional.ToNullable(rulePriority), Optional.ToNullable(isDisabled), Optional.ToNullable(ruleType), Optional.ToNullable(sourceResourceType), Optional.ToList(excludedScopes), Optional.ToList(conditionSets), Optional.ToNullable(inheritRules), ownerSource.Value, governanceEmailNotification.Value, metadata.Value);
        }
    }
}
