...
namespace Azure.IoT.NewServiceDemo
{
    ...
    public partial class DeviceManagementClient
    {
        ...
        /// var client = new DeviceManagementClient("<https://my-service.azure.com>", "<instanceId>", credential);
        /// 
        ...
        /// var client = new DeviceManagementClient("<https://my-service.azure.com>", "<instanceId>", credential);
        /// 
        /// Response response = await client.GetDeviceClassSubgroupsForGroupsAsync("<groupId>", "<filter>");
        /// 
        /// JsonElement result = JsonDocument.Parse(response.ContentStream).RootElement;
        /// Console.WriteLine(result.GetProperty("value")[0].GetProperty("deviceClassId").ToString());
        /// Console.WriteLine(result.GetProperty("value")[0].GetProperty("groupId").ToString());
        ...
        /// var client = new DeviceManagementClient("<https://my-service.azure.com>", "<instanceId>", credential);
        /// 
        /// Response response = client.GetDeviceClassSubgroupsForGroups("<groupId>", "<filter>");
        /// 
        /// JsonElement result = JsonDocument.Parse(response.ContentStream).RootElement;
        /// Console.WriteLine(result.GetProperty("value")[0].GetProperty("deviceClassId").ToString());
        /// Console.WriteLine(result.GetProperty("value")[0].GetProperty("groupId").ToString());
        ...
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <example>
        /// This sample shows how to call GetDeviceClassSubgroupDetailsAsync with required parameters and parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var client = new DeviceManagementClient("<https://my-service.azure.com>", "<instanceId>", credential);
        /// 
        ...
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <example>
        /// This sample shows how to call GetDeviceClassSubgroupDetails with required parameters and parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var client = new DeviceManagementClient("<https://my-service.azure.com>", "<instanceId>", credential);
        /// 
        ...
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <example>
        /// This sample shows how to call GetBestUpdatesForDeviceClassSubgroupsAsync with required parameters and parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var client = new DeviceManagementClient("<https://my-service.azure.com>", "<instanceId>", credential);
        /// 
        ...
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <example>
        /// This sample shows how to call GetBestUpdatesForDeviceClassSubgroups with required parameters and parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var client = new DeviceManagementClient("<https://my-service.azure.com>", "<instanceId>", credential);
        /// 
        ...
        /// <returns> The response returned from the service. </returns>
        /// <example>
        /// This sample shows how to call DeleteDeviceClassSubgroupDeploymentAsync with required parameters.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var client = new DeviceManagementClient("<https://my-service.azure.com>", "<instanceId>", credential);
        /// 
        ...
        /// <returns> The response returned from the service. </returns>
        /// <example>
        /// This sample shows how to call DeleteDeviceClassSubgroupDeployment with required parameters.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var client = new DeviceManagementClient("<https://my-service.azure.com>", "<instanceId>", credential);
        /// 
        ...
        /// <returns> The <see cref="AsyncPageable{T}"/> from the service containing a list of <see cref="BinaryData"/> objects. Details of the body schema for each item in the collection are in the Remarks section below. </returns>
        /// <example>
        /// This sample shows how to call GetDevicesForDeviceClassSubgroupDeploymentsAsync with required parameters and parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var client = new DeviceManagementClient("<https://my-service.azure.com>", "<instanceId>", credential);
        /// 
        /// await foreach (var data in client.GetDevicesForDeviceClassSubgroupDeploymentsAsync("<groupId>", "<deviceClassId>", "<deploymentId>"))
        /// {
        ///     JsonElement result = JsonDocument.Parse(data.ToStream()).RootElement;
        ///     Console.WriteLine(result.GetProperty("deviceId").ToString());
        ...
        /// }
        /// ]]></code>
        /// This sample shows how to call GetDevicesForDeviceClassSubgroupDeploymentsAsync with all parameters, and how to parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var client = new DeviceManagementClient("<https://my-service.azure.com>", "<instanceId>", credential);
        /// 
        /// await foreach (var data in client.GetDevicesForDeviceClassSubgroupDeploymentsAsync("<groupId>", "<deviceClassId>", "<deploymentId>", "<filter>"))
        /// {
        ///     JsonElement result = JsonDocument.Parse(data.ToStream()).RootElement;
        ///     Console.WriteLine(result.GetProperty("deviceId").ToString());
        ///     Console.WriteLine(result.GetProperty("moduleId").ToString());
        ...
        /// <returns> The <see cref="Pageable{T}"/> from the service containing a list of <see cref="BinaryData"/> objects. Details of the body schema for each item in the collection are in the Remarks section below. </returns>
        /// <example>
        /// This sample shows how to call GetDevicesForDeviceClassSubgroupDeployments with required parameters and parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var client = new DeviceManagementClient("<https://my-service.azure.com>", "<instanceId>", credential);
        /// 
        /// foreach (var data in client.GetDevicesForDeviceClassSubgroupDeployments("<groupId>", "<deviceClassId>", "<deploymentId>"))
        /// {
        ///     JsonElement result = JsonDocument.Parse(data.ToStream()).RootElement;
        ///     Console.WriteLine(result.GetProperty("deviceId").ToString());
        ///     Console.WriteLine(result.GetProperty("retryCount").ToString());
        ...
        /// }
        /// ]]></code>
        /// This sample shows how to call GetDevicesForDeviceClassSubgroupDeployments with all parameters, and how to parse the result.
        /// <code><![CDATA[
        /// var credential = new DefaultAzureCredential();
        /// var client = new DeviceManagementClient("<https://my-service.azure.com>", "<instanceId>", credential);
        /// 
        /// foreach (var data in client.GetDevicesForDeviceClassSubgroupDeployments("<groupId>", "<deviceClassId>", "<deploymentId>", "<filter>"))
        /// {
        ///     JsonElement result = JsonDocument.Parse(data.ToStream()).RootElement;
        ///     Console.WriteLine(result.GetProperty("deviceId").ToString());
        ///     Console.WriteLine(result.GetProperty("moduleId").ToString());
