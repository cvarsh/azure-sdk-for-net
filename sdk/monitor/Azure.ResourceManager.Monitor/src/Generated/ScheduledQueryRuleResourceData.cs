...
{
    /// <summary> A class representing the ScheduledQueryRuleResource data model. </summary>
    public partial class ScheduledQueryRuleResourceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of ScheduledQueryRuleResourceData. </summary>
        /// <param name="location"> The location. </param>
        public ScheduledQueryRuleResourceData(AzureLocation location) : base(location)
        {
