...
namespace Azure.ResourceManager.Monitor
{
    ...
    public partial class DiagnosticSettingsCategoryData : ResourceData
    {
        ...
        internal DiagnosticSettingsCategoryData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, CategoryType? categoryType, IList<string> categoryGroups) : base(id, name, resourceType, systemData)
        {
