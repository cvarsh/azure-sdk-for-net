...
namespace Azure.ResourceManager.Monitor.Models
{
    public partial class Condition : IUtf8JsonSerializable
    {
        ...
        internal static Condition DeserializeCondition(JsonElement element)
        {
            ...
            return new Condition(query.Value, Optional.ToNullable(timeAggregation), metricMeasureColumn.Value, resourceIdColumn.Value, Optional.ToList(dimensions), Optional.ToNullable(@operator), Optional.ToNullable(threshold), failingPeriods.Value, metricName.Value);
        }
    }
}
