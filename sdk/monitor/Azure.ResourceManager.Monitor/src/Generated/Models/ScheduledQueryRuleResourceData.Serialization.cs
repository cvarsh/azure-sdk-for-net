...
{
    public partial class ScheduledQueryRuleResourceData : IUtf8JsonSerializable
    {
        ...
        internal static ScheduledQueryRuleResourceData DeserializeScheduledQueryRuleResourceData(JsonElement element)
        {
            ...
            Optional<Actions> actions = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("actions"))
                        {
                            ...
                            actions = Actions.DeserializeActions(property0.Value);
                            continue;
                        }
