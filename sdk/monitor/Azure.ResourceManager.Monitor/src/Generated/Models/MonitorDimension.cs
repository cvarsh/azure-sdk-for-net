...
namespace Azure.ResourceManager.Monitor.Models
{
    ...
    public partial class MonitorDimension
    {
        ...
        public MonitorDimension(string name, DimensionOperator @operator, IEnumerable<string> values)
        {
            if (name == null)
            {
        ...
        /// <param name="operator"> Operator for dimension values. </param>
        /// <param name="values"> List of dimension values. </param>
        internal MonitorDimension(string name, DimensionOperator @operator, IList<string> values)
        {
            Name = name;
            Operator = @operator;
            Values = values;
