...
{
    public partial class Actions : IUtf8JsonSerializable
    {
        ...
        internal static Actions DeserializeActions(JsonElement element)
        {
            ...
            return new Actions(Optional.ToList(actionGroups), Optional.ToDictionary(customProperties));
        }
    }
}
