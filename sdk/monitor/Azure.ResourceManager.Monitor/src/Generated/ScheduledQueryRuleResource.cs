...
namespace Azure.ResourceManager.Monitor
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource" /> using the GetScheduledQueryRuleResource method.
    /// </summary>
    public partial class ScheduledQueryRuleResource : ArmResource
    {
        ...
        {
            _scheduledQueryRuleResourceScheduledQueryRulesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Monitor", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string scheduledQueryRuleResourceScheduledQueryRulesApiVersion);
        ...
        {
            using var scope = _scheduledQueryRuleResourceScheduledQueryRulesClientDiagnostics.CreateScope("ScheduledQueryRuleResource.Get");
            scope.Start();
            try
            {
                var response = await _scheduledQueryRuleResourceScheduledQueryRulesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ScheduledQueryRuleResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _scheduledQueryRuleResourceScheduledQueryRulesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ScheduledQueryRuleResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _scheduledQueryRuleResourceScheduledQueryRulesClientDiagnostics.CreateScope("ScheduledQueryRuleResource.Delete");
            scope.Start();
            try
            {
                var response = await _scheduledQueryRuleResourceScheduledQueryRulesRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _scheduledQueryRuleResourceScheduledQueryRulesRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new MonitorArmOperation(response);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<ScheduledQueryRuleResource>> UpdateAsync(ScheduledQueryRuleResourcePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _scheduledQueryRuleResourceScheduledQueryRulesClientDiagnostics.CreateScope("ScheduledQueryRuleResource.Update");
            scope.Start();
            try
            {
                var response = await _scheduledQueryRuleResourceScheduledQueryRulesRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new ScheduledQueryRuleResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<ScheduledQueryRuleResource> Update(ScheduledQueryRuleResourcePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _scheduledQueryRuleResourceScheduledQueryRulesRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken);
                return Response.FromValue(new ScheduledQueryRuleResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<ScheduledQueryRuleResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _scheduledQueryRuleResourceScheduledQueryRulesClientDiagnostics.CreateScope("ScheduledQueryRuleResource.AddTag");
            scope.Start();
            try
            {
                ...
                var originalResponse = await _scheduledQueryRuleResourceScheduledQueryRulesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ScheduledQueryRuleResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = _scheduledQueryRuleResourceScheduledQueryRulesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                return Response.FromValue(new ScheduledQueryRuleResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<ScheduledQueryRuleResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _scheduledQueryRuleResourceScheduledQueryRulesClientDiagnostics.CreateScope("ScheduledQueryRuleResource.SetTags");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ScheduledQueryRuleResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _scheduledQueryRuleResourceScheduledQueryRulesClientDiagnostics.CreateScope("ScheduledQueryRuleResource.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await GetTagResource().GetAsync(cancellationToken).ConfigureAwait(false);
